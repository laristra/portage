...
#ifndef PORTAGE_DRIVER_COMPONENT_H_
#define PORTAGE_DRIVER_COMPONENT_H_
...
/*!
  @file componentdriver.h
  @brief Component driver for remapping
...
/*!
  @class ComponentDriverBase "componentdriver.h"

  @brief ComponentDriverBase - Base class for component driver that is
...
template<int D,
         ...
         class CoordSys
         >
class ComponentDriverBase {

  template<Entity_kind ONWHAT>
  using ComponentDriverType = ComponentDriver<D, ONWHAT, SourceMesh, SourceState,
...
/*!
  @class ComponentDriver "driver_component.h"

  @brief ComponentDriver - Component driver that remaps fields on a particular Entity_kind (ONWHAT) like CELL or NODE
...
template <int D,
          ...
          >
class ComponentDriver : public ComponentDriverBase<D,
 ...
 public:
  /*!
    @brief Constructor for the COMPONENT remap driver.
  ...
  */
  ComponentDriver(SourceMesh const& source_mesh,
  ...
  ComponentDriver(const ComponentDriver &) = delete;

  /// Assignment operator (disabled)
  ComponentDriver & operator = (const ComponentDriver &) = delete;
  ...
  */
  ...
  /*! ComponentDriver::interpolate_mesh_var
  ...
  */
  ...
  /*! ComponentDriver::interpolate_mat_var
...
template <int D,
          ...
          class Matpoly_Clipper,
          class CoordSys>
std::unique_ptr<ComponentDriverBase<D, SourceMesh, SourceState,
                                   TargetMesh, TargetState,
                                   InterfaceReconstructorType,
                                   Matpoly_Splitter, Matpoly_Clipper,
                                   CoordSys>
                >
make_component_driver(Entity_kind onwhat,
  ...
  switch (onwhat) {
    case CELL:
      // Intel 18.0.1 does not recognize std::make_unique even with -std=c++14 flag *ugh*
      // return std::make_unique<ComponentDriver<D, CELL,
      //                                        SourceMesh, SourceState,
      //                                        TargetMesh, TargetState,
      //                                        InterfaceReconstructorType,
      //                                        Matpoly_Splitter, Matpoly_Clipper,
      ...
      return std::unique_ptr<ComponentDriver<D, CELL,
                                             SourceMesh, SourceState,
                                             TargetMesh, TargetState,
                                             InterfaceReconstructorType,
                                             Matpoly_Splitter, Matpoly_Clipper,
                                             CoordSys>>(
                                                 new ComponentDriver<D, CELL,
                                                 SourceMesh, SourceState,
                                                 TargetMesh, TargetState,
                                                 InterfaceReconstructorType,
                                                 Matpoly_Splitter, Matpoly_Clipper,
    ...
    case NODE:
      // Intel 18.0.1 does not recognize std::make_unique even with -std=c++14 flag *ugh*
      // return std::make_unique<ComponentDriver<D, NODE,
      //                                        SourceMesh, SourceState,
      //                                        TargetMesh, TargetState,
      //                                        InterfaceReconstructorType,
      //                                        Matpoly_Splitter, Matpoly_Clipper,
...
}  // make_component_driver


}  // namespace Portage

#endif  // PORTAGE_DRIVER_COMPONENT_H_
