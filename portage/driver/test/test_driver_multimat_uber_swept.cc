...
TEST(UberDriverSwept, ThreeMat2D_2ndOrder) {
  ...
  targetMesh->node_get_coordinates(4, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(4, pnt.data());
  ...
  targetMesh->node_get_coordinates(7, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(7, pnt.data());
...
TEST(UberDriverSwept, ThreeMat3D_2ndOrder) {
  ...
  targetMesh->node_get_coordinates(16, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(16, pnt.data());
  
  targetMesh->node_get_coordinates(17, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(17, pnt.data());

  targetMesh->node_get_coordinates(18, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(18, pnt.data());

  targetMesh->node_get_coordinates(19, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(19, pnt.data());
  ...
  targetMesh->node_get_coordinates(28, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(28, pnt.data());
  
  targetMesh->node_get_coordinates(29, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(29, pnt.data());
  
  targetMesh->node_get_coordinates(30, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(30, pnt.data());
 
  targetMesh->node_get_coordinates(31, &pnt);
  pnt[0] += DX;
  targetMesh->node_set_coordinates(31, pnt.data());
