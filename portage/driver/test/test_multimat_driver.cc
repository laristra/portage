...
TEST(MMDriver, ThreeMat2D_1stOrder_MOF) {
...
}  // ThreeMat2D_1stOrder_MOF



// 3D Test using MOF

TEST(MMDriver, ThreeMat3D_1stOrder_MOF) {
  // Source and target meshes
  std::shared_ptr<Jali::Mesh> sourceMesh;
  std::shared_ptr<Jali::Mesh> targetMesh;
  // Source and target mesh state
...
}  // ThreeMat3D_1stOrder_MOF


// 2-material problem with VOF


TEST(MMDriver, TwoMat2D_VOF) {
  // Source and target meshes
  std::shared_ptr<Jali::Mesh> sourceMesh;
  std::shared_ptr<Jali::Mesh> targetMesh;
  // Source and target mesh state
