...
#include "portage/simple_mesh/SimpleState.h"
...
TEST(Simple_State, MultiCell) {
  ...
  std::shared_ptr<Portage::SimpleState> mystate =
      Portage::SimpleState::create(std::make_shared<Portage::Simple_Mesh>(mymesh));
  ...
  auto& cellvar1 =
      mystate->add<double, Portage::UniStateVector>("cellvar1", Portage::Entity_kind::CELL);
  ...
  for (int i(0); i < numnodes; ++i)
    nodevar1[i] = i;
  auto retnodevar1 = mystate->add<double>("nodevar1",
  ...
  Portage::UniStateVector<double> cellvar2;
  ...
  auto& cellvar3 = mystate->add<double, Portage::UniStateVector>("cellvar3",
                                                 Portage::Entity_kind::CELL,
                                                       7.0);
