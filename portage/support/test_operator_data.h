...
reference_points<Interval>() { return interval_points_; }

template<>
std::vector<Point<dimension(Quadrilateral)>>
reference_points<Quadrilateral>() { return quadrilateral_points_; }

template<>
std::vector<Point<dimension(Triangle)>>
reference_points<Triangle>() { return triangle_points_; }

template<>
std::vector<Point<dimension(Hexahedron)>>
reference_points<Hexahedron>() { return hexahedron_points_; }

template<>
std::vector<Point<dimension(Wedge)>>
reference_points<Wedge>() { return wedge_points_; }

template<>
std::vector<Point<dimension(Tetrahedron)>>
reference_points<Tetrahedron>() { return tetrahedron_points_; }
...
makeTranslatedExact(
  typename Portage::Meshfree::Basis::Traits<type, dim>::array_t const& values,
