...
TEST(intersectR3D, cube_self_intersection) {
  ...
  std::shared_ptr<Jali::Mesh> sm = mesh_factory("./1x3d.exo");
  ASSERT_TRUE(sm != NULL);

  // read the target exodus file
  std::shared_ptr<Jali::Mesh> tm = mesh_factory("./1x3d.exo");
  ASSERT_TRUE(tm != NULL);
...
TEST(intersectR3D, cube_0_5) {
  ...
  // read the source exodus file
  std::shared_ptr<Jali::Mesh> sm = mesh_factory("./cube_0.exo");
  ASSERT_TRUE(sm != NULL);

  // read the target exodus file
  std::shared_ptr<Jali::Mesh> tm = mesh_factory("./cube_0.5.exo");
  ASSERT_TRUE(tm != NULL);
...
TEST(intersectR3D, cube_no_intersect) {
  ...
  // read the target exodus file
  std::shared_ptr<Jali::Mesh> tm = mesh_factory("./cube_2.exo");
  ASSERT_TRUE(tm != NULL);
...
TEST(intersectR3D, cube_0_1) {
  ...
  // read the target exodus file
  std::shared_ptr<Jali::Mesh> tm = mesh_factory("./cube_1.exo");
  ASSERT_TRUE(tm != NULL);
