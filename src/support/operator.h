  ...
  namespace Meshfree {
	...
	public:
	  ...
	  static result_t apply(const points_t p) {
	    ...
	    result[0][0]=
	      (4*p[0][0]*p[1][2]*p[2][1] - 4*p[0][0]*p[1][1]*p[2][2] + 2*p[1][2]*p[2][1]*p[3][0] - 2*p[1][1]*p[2][2]*p[3][0] - 2*p[1][2]*p[2][0]*p[3][1] + 2*p[1][0]*p[2][2]*p[3][1] + 2*p[1][1]*p[2][0]*p[3][2] - 2*p[1][0]*p[2][1]*p[3][2] - 3*p[1][2]*p[2][1]*p[4][0] + 3*p[1][1]*p[2][2]*p[4][0] + 3*p[1][2]*p[3][1]*p[4][0] + p[2][2]*p[3][1]*p[4][0] - 3*p[1][1]*p[3][2]*p[4][0] - p[2][1]*p[3][2]*p[4][0] - 3*p[0][0]*p[1][2]*p[4][1] + 3*p[1][2]*p[2][0]*p[4][1] + p[0][0]*p[2][2]*p[4][1] - 3*p[1][0]*p[2][2]*p[4][1] - 3*p[1][2]*p[3][0]*p[4][1] - p[2][2]*p[3][0]*p[4][1] + 3*p[1][0]*p[3][2]*p[4][1] + p[2][0]*p[3][2]*p[4][1] + 3*p[0][0]*p[1][1]*p[4][2] - 3*p[1][1]*p[2][0]*p[4][2] - p[0][0]*p[2][1]*p[4][2] + 3*p[1][0]*p[2][1]*p[4][2] + 3*p[1][1]*p[3][0]*p[4][2] + p[2][1]*p[3][0]*p[4][2] - 3*p[1][0]*p[3][1]*p[4][2] - p[2][0]*p[3][1]*p[4][2] - 3*p[1][2]*p[2][1]*p[5][0] + 3*p[1][1]*p[2][2]*p[5][0] - p[1][2]*p[3][1]*p[5][0] - 3*p[2][2]*p[3][1]*p[5][0] + p[1][1]*p[3][2]*p[5][0] + 3*p[2][1]*p[3][2]*p[5][0] + 3*p[1][2]*p[4][1]*p[5][0] + 3*p[2][2]*p[4][1]*p[5][0] - 4*p[3][2]*p[4][1]*p[5][0] - 3*p[1][1]*p[4][2]*p[5][0] - 3*p[2][1]*p[4][2]*p[5][0] + 4*p[3][1]*p[4][2]*p[5][0] - p[0][0]*p[1][2]*p[5][1] + 3*p[1][2]*p[2][0]*p[5][1] + 3*p[0][0]*p[2][2]*p[5][1] - 3*p[1][0]*p[2][2]*p[5][1] + p[1][2]*p[3][0]*p[5][1] + 3*p[2][2]*p[3][0]*p[5][1] - p[1][0]*p[3][2]*p[5][1] - 3*p[2][0]*p[3][2]*p[5][1] - 3*p[1][2]*p[4][0]*p[5][1] - 3*p[2][2]*p[4][0]*p[5][1] + 4*p[3][2]*p[4][0]*p[5][1] - 2*p[0][0]*p[4][2]*p[5][1] + 3*p[1][0]*p[4][2]*p[5][1] + 3*p[2][0]*p[4][2]*p[5][1] - 4*p[3][0]*p[4][2]*p[5][1] + p[0][2]*(p[2][1]*p[4][0] - p[2][0]*p[4][1] + p[1][1]*(4*p[2][0] - 3*p[4][0] - p[5][0]) + 3*p[2][1]*p[5][0] - 2*p[4][1]*p[5][0] - 3*p[2][0]*p[5][1] + 2*p[4][0]*p[5][1] + p[1][0]*(-4*p[2][1] + 3*p[4][1] + p[5][1])) + p[0][0]*p[1][1]*p[5][2] - 3*p[1][1]*p[2][0]*p[5][2] - 3*p[0][0]*p[2][1]*p[5][2] + 3*p[1][0]*p[2][1]*p[5][2] - p[1][1]*p[3][0]*p[5][2] - 3*p[2][1]*p[3][0]*p[5][2] + p[1][0]*p[3][1]*p[5][2] + 3*p[2][0]*p[3][1]*p[5][2] + 3*p[1][1]*p[4][0]*p[5][2] + 3*p[2][1]*p[4][0]*p[5][2] - 4*p[3][1]*p[4][0]*p[5][2] + 2*p[0][0]*p[4][1]*p[5][2] - 3*p[1][0]*p[4][1]*p[5][2] - 3*p[2][0]*p[4][1]*p[5][2] + 4*p[3][0]*p[4][1]*p[5][2] + p[0][1]*(-(p[2][2]*p[4][0]) + p[2][0]*p[4][2] - 3*p[2][2]*p[5][0] + 2*p[4][2]*p[5][0] + p[1][2]*(-4*p[2][0] + 3*p[4][0] + p[5][0]) + p[1][0]*(4*p[2][2] - 3*p[4][2] - p[5][2]) + 3*p[2][0]*p[5][2] - 2*p[4][0]*p[5][2]))/12;
	...
	public:
	  ...
	  static result_t apply(const points_t p) {
	    ...
	    result[1][0]=
	      (-2*pow(p[3][0], 2)*p[1][2]*p[2][1] - 4*pow(p[4][0], 2)*p[1][2]*p[2][1] - 4*pow(p[5][0], 2)*p[1][2]*p[2][1] + 9*p[0][0]*p[1][0]*p[1][2]*p[2][1] + 9*p[0][0]*p[1][2]*p[2][0]*p[2][1] + 2*pow(p[3][0], 2)*p[1][1]*p[2][2] + 4*pow(p[4][0], 2)*p[1][1]*p[2][2] + 4*pow(p[5][0], 2)*p[1][1]*p[2][2] - 9*p[0][0]*p[1][0]*p[1][1]*p[2][2] - 9*p[0][0]*p[1][1]*p[2][0]*p[2][2] - 4*p[0][0]*p[1][2]*p[2][1]*p[3][0] + 5*p[1][0]*p[1][2]*p[2][1]*p[3][0] + 5*p[1][2]*p[2][0]*p[2][1]*p[3][0] + 4*p[0][0]*p[1][1]*p[2][2]*p[3][0] - 5*p[1][0]*p[1][1]*p[2][2]*p[3][0] - 5*p[1][1]*p[2][0]*p[2][2]*p[3][0] - 4*pow(p[0][0], 2)*p[1][2]*p[3][1] - 5*pow(p[2][0], 2)*p[1][2]*p[3][1] + 8*pow(p[4][0], 2)*p[1][2]*p[3][1] - 3*pow(p[5][0], 2)*p[1][2]*p[3][1] + 2*p[0][0]*p[1][0]*p[1][2]*p[3][1] + 6*p[0][0]*p[1][2]*p[2][0]*p[3][1] - 5*p[1][0]*p[1][2]*p[2][0]*p[3][1] + 4*pow(p[0][0], 2)*p[2][2]*p[3][1] + 5*pow(p[1][0], 2)*p[2][2]*p[3][1] + 3*pow(p[4][0], 2)*p[2][2]*p[3][1] - 8*pow(p[5][0], 2)*p[2][2]*p[3][1] - 6*p[0][0]*p[1][0]*p[2][2]*p[3][1] - 2*p[0][0]*p[2][0]*p[2][2]*p[3][1] + 5*p[1][0]*p[2][0]*p[2][2]*p[3][1] - 2*p[0][0]*p[1][2]*p[3][0]*p[3][1] + 2*p[1][2]*p[2][0]*p[3][0]*p[3][1] + 2*p[0][0]*p[2][2]*p[3][0]*p[3][1] - 2*p[1][0]*p[2][2]*p[3][0]*p[3][1] + 4*pow(p[0][0], 2)*p[1][1]*p[3][2] + 5*pow(p[2][0], 2)*p[1][1]*p[3][2] - 8*pow(p[4][0], 2)*p[1][1]*p[3][2] + 3*pow(p[5][0], 2)*p[1][1]*p[3][2] - 2*p[0][0]*p[1][0]*p[1][1]*p[3][2] - 6*p[0][0]*p[1][1]*p[2][0]*p[3][2] + 5*p[1][0]*p[1][1]*p[2][0]*p[3][2] - 4*pow(p[0][0], 2)*p[2][1]*p[3][2] - 5*pow(p[1][0], 2)*p[2][1]*p[3][2] - 3*pow(p[4][0], 2)*p[2][1]*p[3][2] + 8*pow(p[5][0], 2)*p[2][1]*p[3][2] + 6*p[0][0]*p[1][0]*p[2][1]*p[3][2] + 2*p[0][0]*p[2][0]*p[2][1]*p[3][2] - 5*p[1][0]*p[2][0]*p[2][1]*p[3][2] + 2*p[0][0]*p[1][1]*p[3][0]*p[3][2] - 2*p[1][1]*p[2][0]*p[3][0]*p[3][2] - 2*p[0][0]*p[2][1]*p[3][0]*p[3][2] + 2*p[1][0]*p[2][1]*p[3][0]*p[3][2] + 5*p[0][0]*p[1][2]*p[2][1]*p[4][0] - 8*p[1][0]*p[1][2]*p[2][1]*p[4][0] - 6*p[1][2]*p[2][0]*p[2][1]*p[4][0] - 5*p[0][0]*p[1][1]*p[2][2]*p[4][0] + 8*p[1][0]*p[1][1]*p[2][2]*p[4][0] + 6*p[1][1]*p[2][0]*p[2][2]*p[4][0] + 5*p[1][2]*p[2][1]*p[3][0]*p[4][0] - 5*p[1][1]*p[2][2]*p[3][0]*p[4][0] + 4*p[1][0]*p[1][2]*p[3][1]*p[4][0] - p[1][2]*p[2][0]*p[3][1]*p[4][0] - 2*p[0][0]*p[2][2]*p[3][1]*p[4][0] + 4*p[1][0]*p[2][2]*p[3][1]*p[4][0] + p[2][0]*p[2][2]*p[3][1]*p[4][0] - 2*p[1][2]*p[3][0]*p[3][1]*p[4][0] - 2*p[2][2]*p[3][0]*p[3][1]*p[4][0] - 4*p[1][0]*p[1][1]*p[3][2]*p[4][0] + p[1][1]*p[2][0]*p[3][2]*p[4][0] + 2*p[0][0]*p[2][1]*p[3][2]*p[4][0] - 4*p[1][0]*p[2][1]*p[3][2]*p[4][0] - p[2][0]*p[2][1]*p[3][2]*p[4][0] + 2*p[1][1]*p[3][0]*p[3][2]*p[4][0] + 2*p[2][1]*p[3][0]*p[3][2]*p[4][0] + 2*pow(p[0][0], 2)*p[1][2]*p[4][1] + 6*pow(p[2][0], 2)*p[1][2]*p[4][1] + 2*pow(p[3][0], 2)*p[1][2]*p[4][1] + 6*pow(p[5][0], 2)*p[1][2]*p[4][1] - 8*p[0][0]*p[1][0]*p[1][2]*p[4][1] - 8*p[0][0]*p[1][2]*p[2][0]*p[4][1] + 8*p[1][0]*p[1][2]*p[2][0]*p[4][1] - 2*pow(p[0][0], 2)*p[2][2]*p[4][1] - 8*pow(p[1][0], 2)*p[2][2]*p[4][1] + 2*pow(p[3][0], 2)*p[2][2]*p[4][1] + 8*pow(p[5][0], 2)*p[2][2]*p[4][1] + 7*p[0][0]*p[1][0]*p[2][2]*p[4][1] + 3*p[0][0]*p[2][0]*p[2][2]*p[4][1] - 6*p[1][0]*p[2][0]*p[2][2]*p[4][1] + 2*p[0][0]*p[1][2]*p[3][0]*p[4][1] - 4*p[1][0]*p[1][2]*p[3][0]*p[4][1] - 4*p[1][2]*p[2][0]*p[3][0]*p[4][1] + p[1][0]*p[2][2]*p[3][0]*p[4][1] - p[2][0]*p[2][2]*p[3][0]*p[4][1] + 2*pow(p[0][0], 2)*p[3][2]*p[4][1] + 4*pow(p[1][0], 2)*p[3][2]*p[4][1] + pow(p[2][0], 2)*p[3][2]*p[4][1] - 9*pow(p[5][0], 2)*p[3][2]*p[4][1] - 2*p[0][0]*p[1][0]*p[3][2]*p[4][1] - 2*p[0][0]*p[2][0]*p[3][2]*p[4][1] + 3*p[1][0]*p[2][0]*p[3][2]*p[4][1] + 4*p[0][0]*p[3][0]*p[3][2]*p[4][1] - 2*p[1][0]*p[3][0]*p[3][2]*p[4][1] - 2*p[2][0]*p[3][0]*p[3][2]*p[4][1] - 4*p[0][0]*p[1][2]*p[4][0]*p[4][1] + 4*p[1][2]*p[2][0]*p[4][0]*p[4][1] + p[0][0]*p[2][2]*p[4][0]*p[4][1] - 4*p[1][0]*p[2][2]*p[4][0]*p[4][1] - 8*p[1][2]*p[3][0]*p[4][0]*p[4][1] - 3*p[2][2]*p[3][0]*p[4][0]*p[4][1] - 2*p[0][0]*p[3][2]*p[4][0]*p[4][1] + 8*p[1][0]*p[3][2]*p[4][0]*p[4][1] + 3*p[2][0]*p[3][2]*p[4][0]*p[4][1] - 2*pow(p[0][0], 2)*p[1][1]*p[4][2] - 6*pow(p[2][0], 2)*p[1][1]*p[4][2] - 2*pow(p[3][0], 2)*p[1][1]*p[4][2] - 6*pow(p[5][0], 2)*p[1][1]*p[4][2] + 8*p[0][0]*p[1][0]*p[1][1]*p[4][2] + 8*p[0][0]*p[1][1]*p[2][0]*p[4][2] - 8*p[1][0]*p[1][1]*p[2][0]*p[4][2] + 2*pow(p[0][0], 2)*p[2][1]*p[4][2] + 8*pow(p[1][0], 2)*p[2][1]*p[4][2] - 2*pow(p[3][0], 2)*p[2][1]*p[4][2] - 8*pow(p[5][0], 2)*p[2][1]*p[4][2] - 7*p[0][0]*p[1][0]*p[2][1]*p[4][2] - 3*p[0][0]*p[2][0]*p[2][1]*p[4][2] + 6*p[1][0]*p[2][0]*p[2][1]*p[4][2] - 2*p[0][0]*p[1][1]*p[3][0]*p[4][2] + 4*p[1][0]*p[1][1]*p[3][0]*p[4][2] + 4*p[1][1]*p[2][0]*p[3][0]*p[4][2] - p[1][0]*p[2][1]*p[3][0]*p[4][2] + p[2][0]*p[2][1]*p[3][0]*p[4][2] - 2*pow(p[0][0], 2)*p[3][1]*p[4][2] - 4*pow(p[1][0], 2)*p[3][1]*p[4][2] - pow(p[2][0], 2)*p[3][1]*p[4][2] + 9*pow(p[5][0], 2)*p[3][1]*p[4][2] + 2*p[0][0]*p[1][0]*p[3][1]*p[4][2] + 2*p[0][0]*p[2][0]*p[3][1]*p[4][2] - 3*p[1][0]*p[2][0]*p[3][1]*p[4][2] - 4*p[0][0]*p[3][0]*p[3][1]*p[4][2] + 2*p[1][0]*p[3][0]*p[3][1]*p[4][2] + 2*p[2][0]*p[3][0]*p[3][1]*p[4][2] + 4*p[0][0]*p[1][1]*p[4][0]*p[4][2] - 4*p[1][1]*p[2][0]*p[4][0]*p[4][2] - p[0][0]*p[2][1]*p[4][0]*p[4][2] + 4*p[1][0]*p[2][1]*p[4][0]*p[4][2] + 8*p[1][1]*p[3][0]*p[4][0]*p[4][2] + 3*p[2][1]*p[3][0]*p[4][0]*p[4][2] + 2*p[0][0]*p[3][1]*p[4][0]*p[4][2] - 8*p[1][0]*p[3][1]*p[4][0]*p[4][2] - 3*p[2][0]*p[3][1]*p[4][0]*p[4][2] + 5*p[0][0]*p[1][2]*p[2][1]*p[5][0] - 6*p[1][0]*p[1][2]*p[2][1]*p[5][0] - 8*p[1][2]*p[2][0]*p[2][1]*p[5][0] - 5*p[0][0]*p[1][1]*p[2][2]*p[5][0] + 6*p[1][0]*p[1][1]*p[2][2]*p[5][0] + 8*p[1][1]*p[2][0]*p[2][2]*p[5][0] + 5*p[1][2]*p[2][1]*p[3][0]*p[5][0] - 5*p[1][1]*p[2][2]*p[3][0]*p[5][0] + 2*p[0][0]*p[1][2]*p[3][1]*p[5][0] - p[1][0]*p[1][2]*p[3][1]*p[5][0] - 4*p[1][2]*p[2][0]*p[3][1]*p[5][0] + p[1][0]*p[2][2]*p[3][1]*p[5][0] - 4*p[2][0]*p[2][2]*p[3][1]*p[5][0] + 2*p[1][2]*p[3][0]*p[3][1]*p[5][0] + 2*p[2][2]*p[3][0]*p[3][1]*p[5][0] - 2*p[0][0]*p[1][1]*p[3][2]*p[5][0] + p[1][0]*p[1][1]*p[3][2]*p[5][0] + 4*p[1][1]*p[2][0]*p[3][2]*p[5][0] - p[1][0]*p[2][1]*p[3][2]*p[5][0] + 4*p[2][0]*p[2][1]*p[3][2]*p[5][0] - 2*p[1][1]*p[3][0]*p[3][2]*p[5][0] - 2*p[2][1]*p[3][0]*p[3][2]*p[5][0] - 6*p[1][2]*p[2][1]*p[4][0]*p[5][0] + 6*p[1][1]*p[2][2]*p[4][0]*p[5][0] + p[1][2]*p[3][1]*p[4][0]*p[5][0] - p[2][2]*p[3][1]*p[4][0]*p[5][0] - p[1][1]*p[3][2]*p[4][0]*p[5][0] + p[2][1]*p[3][2]*p[4][0]*p[5][0] - 4*p[0][0]*p[1][2]*p[4][1]*p[5][0] + 4*p[1][0]*p[1][2]*p[4][1]*p[5][0] + 6*p[1][2]*p[2][0]*p[4][1]*p[5][0] - p[0][0]*p[2][2]*p[4][1]*p[5][0] + 4*p[2][0]*p[2][2]*p[4][1]*p[5][0] - 8*p[1][2]*p[3][0]*p[4][1]*p[5][0] - 7*p[2][2]*p[3][0]*p[4][1]*p[5][0] - 2*p[0][0]*p[3][2]*p[4][1]*p[5][0] + 3*p[1][0]*p[3][2]*p[4][1]*p[5][0] + 2*p[2][0]*p[3][2]*p[4][1]*p[5][0] + 8*p[1][2]*p[4][0]*p[4][1]*p[5][0] + 6*p[2][2]*p[4][0]*p[4][1]*p[5][0] - 9*p[3][2]*p[4][0]*p[4][1]*p[5][0] + 4*p[0][0]*p[1][1]*p[4][2]*p[5][0] - 4*p[1][0]*p[1][1]*p[4][2]*p[5][0] - 6*p[1][1]*p[2][0]*p[4][2]*p[5][0] + p[0][0]*p[2][1]*p[4][2]*p[5][0] - 4*p[2][0]*p[2][1]*p[4][2]*p[5][0] + 8*p[1][1]*p[3][0]*p[4][2]*p[5][0] + 7*p[2][1]*p[3][0]*p[4][2]*p[5][0] + 2*p[0][0]*p[3][1]*p[4][2]*p[5][0] - 3*p[1][0]*p[3][1]*p[4][2]*p[5][0] - 2*p[2][0]*p[3][1]*p[4][2]*p[5][0] - 8*p[1][1]*p[4][0]*p[4][2]*p[5][0] - 6*p[2][1]*p[4][0]*p[4][2]*p[5][0] + 9*p[3][1]*p[4][0]*p[4][2]*p[5][0] + 2*pow(p[0][0], 2)*p[1][2]*p[5][1] + 8*pow(p[2][0], 2)*p[1][2]*p[5][1] - 2*pow(p[3][0], 2)*p[1][2]*p[5][1] - 8*pow(p[4][0], 2)*p[1][2]*p[5][1] - 3*p[0][0]*p[1][0]*p[1][2]*p[5][1] - 7*p[0][0]*p[1][2]*p[2][0]*p[5][1] + 6*p[1][0]*p[1][2]*p[2][0]*p[5][1] - 2*pow(p[0][0], 2)*p[2][2]*p[5][1] - 6*pow(p[1][0], 2)*p[2][2]*p[5][1] - 2*pow(p[3][0], 2)*p[2][2]*p[5][1] - 6*pow(p[4][0], 2)*p[2][2]*p[5][1] + 8*p[0][0]*p[1][0]*p[2][2]*p[5][1] + 8*p[0][0]*p[2][0]*p[2][2]*p[5][1] - 8*p[1][0]*p[2][0]*p[2][2]*p[5][1] + p[1][0]*p[1][2]*p[3][0]*p[5][1] - p[1][2]*p[2][0]*p[3][0]*p[5][1] - 2*p[0][0]*p[2][2]*p[3][0]*p[5][1] + 4*p[1][0]*p[2][2]*p[3][0]*p[5][1] + 4*p[2][0]*p[2][2]*p[3][0]*p[5][1] - 2*pow(p[0][0], 2)*p[3][2]*p[5][1] - pow(p[1][0], 2)*p[3][2]*p[5][1] - 4*pow(p[2][0], 2)*p[3][2]*p[5][1] + 9*pow(p[4][0], 2)*p[3][2]*p[5][1] + 2*p[0][0]*p[1][0]*p[3][2]*p[5][1] + 2*p[0][0]*p[2][0]*p[3][2]*p[5][1] - 3*p[1][0]*p[2][0]*p[3][2]*p[5][1] - 4*p[0][0]*p[3][0]*p[3][2]*p[5][1] + 2*p[1][0]*p[3][0]*p[3][2]*p[5][1] + 2*p[2][0]*p[3][0]*p[3][2]*p[5][1] + p[0][0]*p[1][2]*p[4][0]*p[5][1] - 4*p[1][0]*p[1][2]*p[4][0]*p[5][1] + 4*p[0][0]*p[2][2]*p[4][0]*p[5][1] - 6*p[1][0]*p[2][2]*p[4][0]*p[5][1] - 4*p[2][0]*p[2][2]*p[4][0]*p[5][1] + 7*p[1][2]*p[3][0]*p[4][0]*p[5][1] + 8*p[2][2]*p[3][0]*p[4][0]*p[5][1] + 2*p[0][0]*p[3][2]*p[4][0]*p[5][1] - 2*p[1][0]*p[3][2]*p[4][0]*p[5][1] - 3*p[2][0]*p[3][2]*p[4][0]*p[5][1] + 2*pow(p[0][0], 2)*p[4][2]*p[5][1] + 4*pow(p[1][0], 2)*p[4][2]*p[5][1] + 4*pow(p[2][0], 2)*p[4][2]*p[5][1] - 5*p[0][0]*p[1][0]*p[4][2]*p[5][1] - 5*p[0][0]*p[2][0]*p[4][2]*p[5][1] + 6*p[1][0]*p[2][0]*p[4][2]*p[5][1] + 4*p[0][0]*p[3][0]*p[4][2]*p[5][1] - 5*p[1][0]*p[3][0]*p[4][2]*p[5][1] - 5*p[2][0]*p[3][0]*p[4][2]*p[5][1] - 5*p[0][0]*p[4][0]*p[4][2]*p[5][1] + 8*p[1][0]*p[4][0]*p[4][2]*p[5][1] + 6*p[2][0]*p[4][0]*p[4][2]*p[5][1] - 9*p[3][0]*p[4][0]*p[4][2]*p[5][1] - p[0][0]*p[1][2]*p[5][0]*p[5][1] + 4*p[1][2]*p[2][0]*p[5][0]*p[5][1] + 4*p[0][0]*p[2][2]*p[5][0]*p[5][1] - 4*p[1][0]*p[2][2]*p[5][0]*p[5][1] + 3*p[1][2]*p[3][0]*p[5][0]*p[5][1] + 8*p[2][2]*p[3][0]*p[5][0]*p[5][1] + 2*p[0][0]*p[3][2]*p[5][0]*p[5][1] - 3*p[1][0]*p[3][2]*p[5][0]*p[5][1] - 8*p[2][0]*p[3][2]*p[5][0]*p[5][1] - 6*p[1][2]*p[4][0]*p[5][0]*p[5][1] - 8*p[2][2]*p[4][0]*p[5][0]*p[5][1] + 9*p[3][2]*p[4][0]*p[5][0]*p[5][1] - 5*p[0][0]*p[4][2]*p[5][0]*p[5][1] + 6*p[1][0]*p[4][2]*p[5][0]*p[5][1] + 8*p[2][0]*p[4][2]*p[5][0]*p[5][1] - 9*p[3][0]*p[4][2]*p[5][0]*p[5][1] + p[0][2]*(2*pow(p[3][0], 2)*p[2][1] + pow(p[4][0], 2)*p[2][1] + 4*pow(p[5][0], 2)*p[2][1] + 4*p[0][0]*p[2][1]*p[3][0] - 2*p[2][0]*p[2][1]*p[3][0] + 2*pow(p[2][0], 2)*p[3][1] - 2*pow(p[4][0], 2)*p[3][1] + 2*pow(p[5][0], 2)*p[3][1] - 4*p[0][0]*p[2][0]*p[3][1] - 2*p[2][0]*p[3][0]*p[3][1] - 2*p[0][0]*p[2][1]*p[4][0] + 3*p[2][0]*p[2][1]*p[4][0] - 2*p[2][1]*p[3][0]*p[4][0] + 2*p[0][0]*p[3][1]*p[4][0] + 4*p[3][0]*p[3][1]*p[4][0] - 3*pow(p[2][0], 2)*p[4][1] - 4*pow(p[3][0], 2)*p[4][1] - 5*pow(p[5][0], 2)*p[4][1] + 2*p[0][0]*p[2][0]*p[4][1] - 2*p[0][0]*p[3][0]*p[4][1] + 2*p[2][0]*p[3][0]*p[4][1] - p[2][0]*p[4][0]*p[4][1] + 2*p[3][0]*p[4][0]*p[4][1] - 2*p[0][0]*p[2][1]*p[5][0] + 8*p[2][0]*p[2][1]*p[5][0] - 2*p[2][1]*p[3][0]*p[5][0] - 2*p[0][0]*p[3][1]*p[5][0] + 2*p[2][0]*p[3][1]*p[5][0] - 4*p[3][0]*p[3][1]*p[5][0] + 3*p[2][1]*p[4][0]*p[5][0] + 2*p[0][0]*p[4][1]*p[5][0] - 4*p[2][0]*p[4][1]*p[5][0] + 6*p[3][0]*p[4][1]*p[5][0] - 5*p[4][0]*p[4][1]*p[5][0] + p[1][1]*(9*pow(p[2][0], 2) - 2*pow(p[3][0], 2) - 4*pow(p[4][0], 2) - pow(p[5][0], 2) + 2*p[3][0]*p[4][0] + p[2][0]*(2*p[3][0] - 3*p[4][0] - 2*p[5][0]) + 2*p[3][0]*p[5][0] - 3*p[4][0]*p[5][0] + 2*p[0][0]*(-2*p[3][0] + p[4][0] + p[5][0])) - 8*pow(p[2][0], 2)*p[5][1] + 4*pow(p[3][0], 2)*p[5][1] + 5*pow(p[4][0], 2)*p[5][1] + 2*p[0][0]*p[2][0]*p[5][1] + 2*p[0][0]*p[3][0]*p[5][1] - 2*p[0][0]*p[4][0]*p[5][1] + p[2][0]*p[4][0]*p[5][1] - 6*p[3][0]*p[4][0]*p[5][1] - 4*p[2][0]*p[5][0]*p[5][1] - 2*p[3][0]*p[5][0]*p[5][1] + 5*p[4][0]*p[5][0]*p[5][1] + pow(p[1][0], 2)*(-9*p[2][1] - 2*p[3][1] + 8*p[4][1] + 3*p[5][1]) + p[1][0]*(-2*p[2][1]*p[3][0] + 4*p[0][0]*p[3][1] + 2*p[3][0]*p[3][1] + 2*p[2][1]*p[4][0] - 2*p[3][1]*p[4][0] - 2*p[0][0]*p[4][1] + 4*p[4][0]*p[4][1] + p[1][1]*(9*p[2][0] + 2*p[3][0] - 8*p[4][0] - 3*p[5][0]) + 3*p[2][1]*p[5][0] - p[4][1]*p[5][0] + p[2][0]*(-9*p[2][1] + p[4][1] - p[5][1]) - 2*p[0][0]*p[5][1] - 2*p[3][0]*p[5][1] + 4*p[4][0]*p[5][1] + p[5][0]*p[5][1])) - 2*pow(p[0][0], 2)*p[1][1]*p[5][2] - 8*pow(p[2][0], 2)*p[1][1]*p[5][2] + 2*pow(p[3][0], 2)*p[1][1]*p[5][2] + 8*pow(p[4][0], 2)*p[1][1]*p[5][2] + 3*p[0][0]*p[1][0]*p[1][1]*p[5][2] + 7*p[0][0]*p[1][1]*p[2][0]*p[5][2] - 6*p[1][0]*p[1][1]*p[2][0]*p[5][2] + 2*pow(p[0][0], 2)*p[2][1]*p[5][2] + 6*pow(p[1][0], 2)*p[2][1]*p[5][2] + 2*pow(p[3][0], 2)*p[2][1]*p[5][2] + 6*pow(p[4][0], 2)*p[2][1]*p[5][2] - 8*p[0][0]*p[1][0]*p[2][1]*p[5][2] - 8*p[0][0]*p[2][0]*p[2][1]*p[5][2] + 8*p[1][0]*p[2][0]*p[2][1]*p[5][2] - p[1][0]*p[1][1]*p[3][0]*p[5][2] + p[1][1]*p[2][0]*p[3][0]*p[5][2] + 2*p[0][0]*p[2][1]*p[3][0]*p[5][2] - 4*p[1][0]*p[2][1]*p[3][0]*p[5][2] - 4*p[2][0]*p[2][1]*p[3][0]*p[5][2] + 2*pow(p[0][0], 2)*p[3][1]*p[5][2] + pow(p[1][0], 2)*p[3][1]*p[5][2] + 4*pow(p[2][0], 2)*p[3][1]*p[5][2] - 9*pow(p[4][0], 2)*p[3][1]*p[5][2] - 2*p[0][0]*p[1][0]*p[3][1]*p[5][2] - 2*p[0][0]*p[2][0]*p[3][1]*p[5][2] + 3*p[1][0]*p[2][0]*p[3][1]*p[5][2] + 4*p[0][0]*p[3][0]*p[3][1]*p[5][2] - 2*p[1][0]*p[3][0]*p[3][1]*p[5][2] - 2*p[2][0]*p[3][0]*p[3][1]*p[5][2] - p[0][0]*p[1][1]*p[4][0]*p[5][2] + 4*p[1][0]*p[1][1]*p[4][0]*p[5][2] - 4*p[0][0]*p[2][1]*p[4][0]*p[5][2] + 6*p[1][0]*p[2][1]*p[4][0]*p[5][2] + 4*p[2][0]*p[2][1]*p[4][0]*p[5][2] - 7*p[1][1]*p[3][0]*p[4][0]*p[5][2] - 8*p[2][1]*p[3][0]*p[4][0]*p[5][2] - 2*p[0][0]*p[3][1]*p[4][0]*p[5][2] + 2*p[1][0]*p[3][1]*p[4][0]*p[5][2] + 3*p[2][0]*p[3][1]*p[4][0]*p[5][2] - 2*pow(p[0][0], 2)*p[4][1]*p[5][2] - 4*pow(p[1][0], 2)*p[4][1]*p[5][2] - 4*pow(p[2][0], 2)*p[4][1]*p[5][2] + 5*p[0][0]*p[1][0]*p[4][1]*p[5][2] + 5*p[0][0]*p[2][0]*p[4][1]*p[5][2] - 6*p[1][0]*p[2][0]*p[4][1]*p[5][2] - 4*p[0][0]*p[3][0]*p[4][1]*p[5][2] + 5*p[1][0]*p[3][0]*p[4][1]*p[5][2] + 5*p[2][0]*p[3][0]*p[4][1]*p[5][2] + 5*p[0][0]*p[4][0]*p[4][1]*p[5][2] - 8*p[1][0]*p[4][0]*p[4][1]*p[5][2] - 6*p[2][0]*p[4][0]*p[4][1]*p[5][2] + 9*p[3][0]*p[4][0]*p[4][1]*p[5][2] + p[0][0]*p[1][1]*p[5][0]*p[5][2] - 4*p[1][1]*p[2][0]*p[5][0]*p[5][2] - 4*p[0][0]*p[2][1]*p[5][0]*p[5][2] + 4*p[1][0]*p[2][1]*p[5][0]*p[5][2] - 3*p[1][1]*p[3][0]*p[5][0]*p[5][2] - 8*p[2][1]*p[3][0]*p[5][0]*p[5][2] - 2*p[0][0]*p[3][1]*p[5][0]*p[5][2] + 3*p[1][0]*p[3][1]*p[5][0]*p[5][2] + 8*p[2][0]*p[3][1]*p[5][0]*p[5][2] + 6*p[1][1]*p[4][0]*p[5][0]*p[5][2] + 8*p[2][1]*p[4][0]*p[5][0]*p[5][2] - 9*p[3][1]*p[4][0]*p[5][0]*p[5][2] + 5*p[0][0]*p[4][1]*p[5][0]*p[5][2] - 6*p[1][0]*p[4][1]*p[5][0]*p[5][2] - 8*p[2][0]*p[4][1]*p[5][0]*p[5][2] + 9*p[3][0]*p[4][1]*p[5][0]*p[5][2] + p[0][1]*(-2*pow(p[3][0], 2)*p[2][2] - pow(p[4][0], 2)*p[2][2] - 4*pow(p[5][0], 2)*p[2][2] - 4*p[0][0]*p[2][2]*p[3][0] + 2*p[2][0]*p[2][2]*p[3][0] - 2*pow(p[2][0], 2)*p[3][2] + 2*pow(p[4][0], 2)*p[3][2] - 2*pow(p[5][0], 2)*p[3][2] + 4*p[0][0]*p[2][0]*p[3][2] + 2*p[2][0]*p[3][0]*p[3][2] + 2*p[0][0]*p[2][2]*p[4][0] - 3*p[2][0]*p[2][2]*p[4][0] + 2*p[2][2]*p[3][0]*p[4][0] - 2*p[0][0]*p[3][2]*p[4][0] - 4*p[3][0]*p[3][2]*p[4][0] + 3*pow(p[2][0], 2)*p[4][2] + 4*pow(p[3][0], 2)*p[4][2] + 5*pow(p[5][0], 2)*p[4][2] - 2*p[0][0]*p[2][0]*p[4][2] + 2*p[0][0]*p[3][0]*p[4][2] - 2*p[2][0]*p[3][0]*p[4][2] + p[2][0]*p[4][0]*p[4][2] - 2*p[3][0]*p[4][0]*p[4][2] + 2*p[0][0]*p[2][2]*p[5][0] - 8*p[2][0]*p[2][2]*p[5][0] + 2*p[2][2]*p[3][0]*p[5][0] + 2*p[0][0]*p[3][2]*p[5][0] - 2*p[2][0]*p[3][2]*p[5][0] + 4*p[3][0]*p[3][2]*p[5][0] - 3*p[2][2]*p[4][0]*p[5][0] - 2*p[0][0]*p[4][2]*p[5][0] + 4*p[2][0]*p[4][2]*p[5][0] - 6*p[3][0]*p[4][2]*p[5][0] + 5*p[4][0]*p[4][2]*p[5][0] + p[1][2]*(-9*pow(p[2][0], 2) + 2*pow(p[3][0], 2) + 4*pow(p[4][0], 2) + pow(p[5][0], 2) - 2*p[3][0]*p[4][0] - 2*p[3][0]*p[5][0] + 3*p[4][0]*p[5][0] + p[2][0]*(-2*p[3][0] + 3*p[4][0] + 2*p[5][0]) + p[0][0]*(4*p[3][0] - 2*(p[4][0] + p[5][0]))) + pow(p[1][0], 2)*(9*p[2][2] + 2*p[3][2] - 8*p[4][2] - 3*p[5][2]) + 8*pow(p[2][0], 2)*p[5][2] - 4*pow(p[3][0], 2)*p[5][2] - 5*pow(p[4][0], 2)*p[5][2] - 2*p[0][0]*p[2][0]*p[5][2] - 2*p[0][0]*p[3][0]*p[5][2] + 2*p[0][0]*p[4][0]*p[5][2] - p[2][0]*p[4][0]*p[5][2] + 6*p[3][0]*p[4][0]*p[5][2] + 4*p[2][0]*p[5][0]*p[5][2] + 2*p[3][0]*p[5][0]*p[5][2] - 5*p[4][0]*p[5][0]*p[5][2] + p[1][0]*(2*p[2][2]*p[3][0] - 4*p[0][0]*p[3][2] - 2*p[3][0]*p[3][2] - 2*p[2][2]*p[4][0] + 2*p[3][2]*p[4][0] + 2*p[0][0]*p[4][2] - 4*p[4][0]*p[4][2] - 3*p[2][2]*p[5][0] + p[4][2]*p[5][0] + p[1][2]*(-9*p[2][0] - 2*p[3][0] + 8*p[4][0] + 3*p[5][0]) + 2*p[0][0]*p[5][2] + 2*p[3][0]*p[5][2] - 4*p[4][0]*p[5][2] - p[5][0]*p[5][2] + p[2][0]*(9*p[2][2] - p[4][2] + p[5][2]))))/72;


	    result[2][0]=
	      (9*pow(p[2][1], 2)*p[0][0]*p[1][2] - 2*pow(p[3][1], 2)*p[0][0]*p[1][2] - 4*pow(p[4][1], 2)*p[0][0]*p[1][2] - pow(p[5][1], 2)*p[0][0]*p[1][2] + 2*pow(p[3][1], 2)*p[1][2]*p[2][0] + 4*pow(p[4][1], 2)*p[1][2]*p[2][0] + 4*pow(p[5][1], 2)*p[1][2]*p[2][0] + 9*p[0][0]*p[1][1]*p[1][2]*p[2][1] - 9*pow(p[1][1], 2)*p[0][0]*p[2][2] + 2*pow(p[3][1], 2)*p[0][0]*p[2][2] + pow(p[4][1], 2)*p[0][0]*p[2][2] + 4*pow(p[5][1], 2)*p[0][0]*p[2][2] - 2*pow(p[3][1], 2)*p[1][0]*p[2][2] - 4*pow(p[4][1], 2)*p[1][0]*p[2][2] - 4*pow(p[5][1], 2)*p[1][0]*p[2][2] - 9*p[0][0]*p[1][1]*p[2][1]*p[2][2] + 5*pow(p[2][1], 2)*p[1][2]*p[3][0] - 8*pow(p[4][1], 2)*p[1][2]*p[3][0] + 3*pow(p[5][1], 2)*p[1][2]*p[3][0] + 5*p[1][1]*p[1][2]*p[2][1]*p[3][0] - 5*pow(p[1][1], 2)*p[2][2]*p[3][0] - 3*pow(p[4][1], 2)*p[2][2]*p[3][0] + 8*pow(p[5][1], 2)*p[2][2]*p[3][0] - 5*p[1][1]*p[2][1]*p[2][2]*p[3][0] + 2*p[0][0]*p[1][1]*p[1][2]*p[3][1] - 5*p[1][1]*p[1][2]*p[2][0]*p[3][1] + 2*p[0][0]*p[1][2]*p[2][1]*p[3][1] - 5*p[1][2]*p[2][0]*p[2][1]*p[3][1] - 2*p[0][0]*p[1][1]*p[2][2]*p[3][1] + 5*p[1][0]*p[1][1]*p[2][2]*p[3][1] - 2*p[0][0]*p[2][1]*p[2][2]*p[3][1] + 5*p[1][0]*p[2][1]*p[2][2]*p[3][1] - 2*p[1][2]*p[2][1]*p[3][0]*p[3][1] + 2*p[1][1]*p[2][2]*p[3][0]*p[3][1] - 2*pow(p[1][1], 2)*p[0][0]*p[3][2] + 2*pow(p[2][1], 2)*p[0][0]*p[3][2] - 2*pow(p[4][1], 2)*p[0][0]*p[3][2] + 2*pow(p[5][1], 2)*p[0][0]*p[3][2] - 5*pow(p[2][1], 2)*p[1][0]*p[3][2] + 8*pow(p[4][1], 2)*p[1][0]*p[3][2] - 3*pow(p[5][1], 2)*p[1][0]*p[3][2] + 5*pow(p[1][1], 2)*p[2][0]*p[3][2] + 3*pow(p[4][1], 2)*p[2][0]*p[3][2] - 8*pow(p[5][1], 2)*p[2][0]*p[3][2] - 5*p[1][0]*p[1][1]*p[2][1]*p[3][2] + 5*p[1][1]*p[2][0]*p[2][1]*p[3][2] + 2*p[0][0]*p[1][1]*p[3][1]*p[3][2] - 2*p[1][1]*p[2][0]*p[3][1]*p[3][2] - 2*p[0][0]*p[2][1]*p[3][1]*p[3][2] + 2*p[1][0]*p[2][1]*p[3][1]*p[3][2] - 6*pow(p[2][1], 2)*p[1][2]*p[4][0] - 2*pow(p[3][1], 2)*p[1][2]*p[4][0] - 6*pow(p[5][1], 2)*p[1][2]*p[4][0] - 8*p[1][1]*p[1][2]*p[2][1]*p[4][0] + 8*pow(p[1][1], 2)*p[2][2]*p[4][0] - 2*pow(p[3][1], 2)*p[2][2]*p[4][0] - 8*pow(p[5][1], 2)*p[2][2]*p[4][0] + 6*p[1][1]*p[2][1]*p[2][2]*p[4][0] + 4*p[1][1]*p[1][2]*p[3][1]*p[4][0] + 4*p[1][2]*p[2][1]*p[3][1]*p[4][0] - p[1][1]*p[2][2]*p[3][1]*p[4][0] + p[2][1]*p[2][2]*p[3][1]*p[4][0] - 4*pow(p[1][1], 2)*p[3][2]*p[4][0] - pow(p[2][1], 2)*p[3][2]*p[4][0] + 9*pow(p[5][1], 2)*p[3][2]*p[4][0] - 3*p[1][1]*p[2][1]*p[3][2]*p[4][0] + 2*p[1][1]*p[3][1]*p[3][2]*p[4][0] + 2*p[2][1]*p[3][1]*p[3][2]*p[4][0] - 8*p[0][0]*p[1][1]*p[1][2]*p[4][1] + 8*p[1][1]*p[1][2]*p[2][0]*p[4][1] - 3*p[0][0]*p[1][2]*p[2][1]*p[4][1] + 6*p[1][2]*p[2][0]*p[2][1]*p[4][1] + 2*p[0][0]*p[1][1]*p[2][2]*p[4][1] - 8*p[1][0]*p[1][1]*p[2][2]*p[4][1] + 3*p[0][0]*p[2][1]*p[2][2]*p[4][1] - 6*p[1][0]*p[2][1]*p[2][2]*p[4][1] - 4*p[1][1]*p[1][2]*p[3][0]*p[4][1] + p[1][2]*p[2][1]*p[3][0]*p[4][1] - 4*p[1][1]*p[2][2]*p[3][0]*p[4][1] - p[2][1]*p[2][2]*p[3][0]*p[4][1] + 2*p[0][0]*p[1][2]*p[3][1]*p[4][1] - 5*p[1][2]*p[2][0]*p[3][1]*p[4][1] - 2*p[0][0]*p[2][2]*p[3][1]*p[4][1] + 5*p[1][0]*p[2][2]*p[3][1]*p[4][1] + 2*p[1][2]*p[3][0]*p[3][1]*p[4][1] + 2*p[2][2]*p[3][0]*p[3][1]*p[4][1] - 2*p[0][0]*p[1][1]*p[3][2]*p[4][1] + 4*p[1][0]*p[1][1]*p[3][2]*p[4][1] + 4*p[1][1]*p[2][0]*p[3][2]*p[4][1] - p[1][0]*p[2][1]*p[3][2]*p[4][1] + p[2][0]*p[2][1]*p[3][2]*p[4][1] + 4*p[0][0]*p[3][1]*p[3][2]*p[4][1] - 2*p[1][0]*p[3][1]*p[3][2]*p[4][1] - 2*p[2][0]*p[3][1]*p[3][2]*p[4][1] - 4*p[1][2]*p[2][1]*p[4][0]*p[4][1] + 4*p[1][1]*p[2][2]*p[4][0]*p[4][1] + 8*p[1][2]*p[3][1]*p[4][0]*p[4][1] + 3*p[2][2]*p[3][1]*p[4][0]*p[4][1] - 8*p[1][1]*p[3][2]*p[4][0]*p[4][1] - 3*p[2][1]*p[3][2]*p[4][0]*p[4][1] + 8*pow(p[1][1], 2)*p[0][0]*p[4][2] - 3*pow(p[2][1], 2)*p[0][0]*p[4][2] - 4*pow(p[3][1], 2)*p[0][0]*p[4][2] - 5*pow(p[5][1], 2)*p[0][0]*p[4][2] + 6*pow(p[2][1], 2)*p[1][0]*p[4][2] + 2*pow(p[3][1], 2)*p[1][0]*p[4][2] + 6*pow(p[5][1], 2)*p[1][0]*p[4][2] - 8*pow(p[1][1], 2)*p[2][0]*p[4][2] + 2*pow(p[3][1], 2)*p[2][0]*p[4][2] + 8*pow(p[5][1], 2)*p[2][0]*p[4][2] + p[0][0]*p[1][1]*p[2][1]*p[4][2] + 8*p[1][0]*p[1][1]*p[2][1]*p[4][2] - 6*p[1][1]*p[2][0]*p[2][1]*p[4][2] + 4*pow(p[1][1], 2)*p[3][0]*p[4][2] + pow(p[2][1], 2)*p[3][0]*p[4][2] - 9*pow(p[5][1], 2)*p[3][0]*p[4][2] + 3*p[1][1]*p[2][1]*p[3][0]*p[4][2] - 4*p[1][0]*p[1][1]*p[3][1]*p[4][2] + p[1][1]*p[2][0]*p[3][1]*p[4][2] + 2*p[0][0]*p[2][1]*p[3][1]*p[4][2] - 4*p[1][0]*p[2][1]*p[3][1]*p[4][2] - p[2][0]*p[2][1]*p[3][1]*p[4][2] - 2*p[1][1]*p[3][0]*p[3][1]*p[4][2] - 2*p[2][1]*p[3][0]*p[3][1]*p[4][2] + 4*p[0][0]*p[1][1]*p[4][1]*p[4][2] - 4*p[1][1]*p[2][0]*p[4][1]*p[4][2] - p[0][0]*p[2][1]*p[4][1]*p[4][2] + 4*p[1][0]*p[2][1]*p[4][1]*p[4][2] + 8*p[1][1]*p[3][0]*p[4][1]*p[4][2] + 3*p[2][1]*p[3][0]*p[4][1]*p[4][2] + 2*p[0][0]*p[3][1]*p[4][1]*p[4][2] - 8*p[1][0]*p[3][1]*p[4][1]*p[4][2] - 3*p[2][0]*p[3][1]*p[4][1]*p[4][2] - 8*pow(p[2][1], 2)*p[1][2]*p[5][0] + 2*pow(p[3][1], 2)*p[1][2]*p[5][0] + 8*pow(p[4][1], 2)*p[1][2]*p[5][0] - 6*p[1][1]*p[1][2]*p[2][1]*p[5][0] + 6*pow(p[1][1], 2)*p[2][2]*p[5][0] + 2*pow(p[3][1], 2)*p[2][2]*p[5][0] + 6*pow(p[4][1], 2)*p[2][2]*p[5][0] + 8*p[1][1]*p[2][1]*p[2][2]*p[5][0] - p[1][1]*p[1][2]*p[3][1]*p[5][0] + p[1][2]*p[2][1]*p[3][1]*p[5][0] - 4*p[1][1]*p[2][2]*p[3][1]*p[5][0] - 4*p[2][1]*p[2][2]*p[3][1]*p[5][0] + pow(p[1][1], 2)*p[3][2]*p[5][0] + 4*pow(p[2][1], 2)*p[3][2]*p[5][0] - 9*pow(p[4][1], 2)*p[3][2]*p[5][0] + 3*p[1][1]*p[2][1]*p[3][2]*p[5][0] - 2*p[1][1]*p[3][1]*p[3][2]*p[5][0] - 2*p[2][1]*p[3][1]*p[3][2]*p[5][0] + 4*p[1][1]*p[1][2]*p[4][1]*p[5][0] + 6*p[1][1]*p[2][2]*p[4][1]*p[5][0] + 4*p[2][1]*p[2][2]*p[4][1]*p[5][0] - 7*p[1][2]*p[3][1]*p[4][1]*p[5][0] - 8*p[2][2]*p[3][1]*p[4][1]*p[5][0] + 2*p[1][1]*p[3][2]*p[4][1]*p[5][0] + 3*p[2][1]*p[3][2]*p[4][1]*p[5][0] - 4*pow(p[1][1], 2)*p[4][2]*p[5][0] - 4*pow(p[2][1], 2)*p[4][2]*p[5][0] - 6*p[1][1]*p[2][1]*p[4][2]*p[5][0] + 5*p[1][1]*p[3][1]*p[4][2]*p[5][0] + 5*p[2][1]*p[3][1]*p[4][2]*p[5][0] - 8*p[1][1]*p[4][1]*p[4][2]*p[5][0] - 6*p[2][1]*p[4][1]*p[4][2]*p[5][0] + 9*p[3][1]*p[4][1]*p[4][2]*p[5][0] - 3*p[0][0]*p[1][1]*p[1][2]*p[5][1] + 6*p[1][1]*p[1][2]*p[2][0]*p[5][1] - 2*p[0][0]*p[1][2]*p[2][1]*p[5][1] + 8*p[1][2]*p[2][0]*p[2][1]*p[5][1] + 3*p[0][0]*p[1][1]*p[2][2]*p[5][1] - 6*p[1][0]*p[1][1]*p[2][2]*p[5][1] + 8*p[0][0]*p[2][1]*p[2][2]*p[5][1] - 8*p[1][0]*p[2][1]*p[2][2]*p[5][1] + p[1][1]*p[1][2]*p[3][0]*p[5][1] + 4*p[1][2]*p[2][1]*p[3][0]*p[5][1] - p[1][1]*p[2][2]*p[3][0]*p[5][1] + 4*p[2][1]*p[2][2]*p[3][0]*p[5][1] + 2*p[0][0]*p[1][2]*p[3][1]*p[5][1] - 5*p[1][2]*p[2][0]*p[3][1]*p[5][1] - 2*p[0][0]*p[2][2]*p[3][1]*p[5][1] + 5*p[1][0]*p[2][2]*p[3][1]*p[5][1] - 2*p[1][2]*p[3][0]*p[3][1]*p[5][1] - 2*p[2][2]*p[3][0]*p[3][1]*p[5][1] - p[1][0]*p[1][1]*p[3][2]*p[5][1] + p[1][1]*p[2][0]*p[3][2]*p[5][1] + 2*p[0][0]*p[2][1]*p[3][2]*p[5][1] - 4*p[1][0]*p[2][1]*p[3][2]*p[5][1] - 4*p[2][0]*p[2][1]*p[3][2]*p[5][1] - 4*p[0][0]*p[3][1]*p[3][2]*p[5][1] + 2*p[1][0]*p[3][1]*p[3][2]*p[5][1] + 2*p[2][0]*p[3][1]*p[3][2]*p[5][1] - 4*p[1][1]*p[1][2]*p[4][0]*p[5][1] - 6*p[1][2]*p[2][1]*p[4][0]*p[5][1] - 4*p[2][1]*p[2][2]*p[4][0]*p[5][1] + 8*p[1][2]*p[3][1]*p[4][0]*p[5][1] + 7*p[2][2]*p[3][1]*p[4][0]*p[5][1] - 3*p[1][1]*p[3][2]*p[4][0]*p[5][1] - 2*p[2][1]*p[3][2]*p[4][0]*p[5][1] - 3*p[0][0]*p[1][2]*p[4][1]*p[5][1] + 6*p[1][2]*p[2][0]*p[4][1]*p[5][1] + 3*p[0][0]*p[2][2]*p[4][1]*p[5][1] - 6*p[1][0]*p[2][2]*p[4][1]*p[5][1] - p[1][2]*p[3][0]*p[4][1]*p[5][1] + p[2][2]*p[3][0]*p[4][1]*p[5][1] + p[1][0]*p[3][2]*p[4][1]*p[5][1] - p[2][0]*p[3][2]*p[4][1]*p[5][1] - 8*p[1][2]*p[4][0]*p[4][1]*p[5][1] - 6*p[2][2]*p[4][0]*p[4][1]*p[5][1] + 9*p[3][2]*p[4][0]*p[4][1]*p[5][1] - p[0][0]*p[1][1]*p[4][2]*p[5][1] + 4*p[1][0]*p[1][1]*p[4][2]*p[5][1] - 4*p[0][0]*p[2][1]*p[4][2]*p[5][1] + 6*p[1][0]*p[2][1]*p[4][2]*p[5][1] + 4*p[2][0]*p[2][1]*p[4][2]*p[5][1] + 3*p[1][1]*p[3][0]*p[4][2]*p[5][1] + 2*p[2][1]*p[3][0]*p[4][2]*p[5][1] + 6*p[0][0]*p[3][1]*p[4][2]*p[5][1] - 8*p[1][0]*p[3][1]*p[4][2]*p[5][1] - 7*p[2][0]*p[3][1]*p[4][2]*p[5][1] - 5*p[0][0]*p[4][1]*p[4][2]*p[5][1] + 8*p[1][0]*p[4][1]*p[4][2]*p[5][1] + 6*p[2][0]*p[4][1]*p[4][2]*p[5][1] - 9*p[3][0]*p[4][1]*p[4][2]*p[5][1] - 4*p[1][2]*p[2][1]*p[5][0]*p[5][1] + 4*p[1][1]*p[2][2]*p[5][0]*p[5][1] - 3*p[1][2]*p[3][1]*p[5][0]*p[5][1] - 8*p[2][2]*p[3][1]*p[5][0]*p[5][1] + 3*p[1][1]*p[3][2]*p[5][0]*p[5][1] + 8*p[2][1]*p[3][2]*p[5][0]*p[5][1] + 6*p[1][2]*p[4][1]*p[5][0]*p[5][1] + 8*p[2][2]*p[4][1]*p[5][0]*p[5][1] - 9*p[3][2]*p[4][1]*p[5][0]*p[5][1] - 6*p[1][1]*p[4][2]*p[5][0]*p[5][1] - 8*p[2][1]*p[4][2]*p[5][0]*p[5][1] + 9*p[3][1]*p[4][2]*p[5][0]*p[5][1] + p[0][2]*(-2*pow(p[3][1], 2)*p[2][0] - pow(p[4][1], 2)*p[2][0] - 4*pow(p[5][1], 2)*p[2][0] - 2*pow(p[2][1], 2)*p[3][0] + 2*pow(p[4][1], 2)*p[3][0] - 2*pow(p[5][1], 2)*p[3][0] + 4*p[0][1]*p[2][1]*p[3][0] - 4*p[0][1]*p[2][0]*p[3][1] + 2*p[2][0]*p[2][1]*p[3][1] + 2*p[2][1]*p[3][0]*p[3][1] + 3*pow(p[2][1], 2)*p[4][0] + 4*pow(p[3][1], 2)*p[4][0] + 5*pow(p[5][1], 2)*p[4][0] - 2*p[0][1]*p[2][1]*p[4][0] + 2*p[0][1]*p[3][1]*p[4][0] - 2*p[2][1]*p[3][1]*p[4][0] + 2*p[0][1]*p[2][0]*p[4][1] - 3*p[2][0]*p[2][1]*p[4][1] - 2*p[0][1]*p[3][0]*p[4][1] + 2*p[2][0]*p[3][1]*p[4][1] - 4*p[3][0]*p[3][1]*p[4][1] + p[2][1]*p[4][0]*p[4][1] - 2*p[3][1]*p[4][0]*p[4][1] + pow(p[1][1], 2)*(9*p[2][0] + 2*p[3][0] - 8*p[4][0] - 3*p[5][0]) + 8*pow(p[2][1], 2)*p[5][0] - 4*pow(p[3][1], 2)*p[5][0] - 5*pow(p[4][1], 2)*p[5][0] - 2*p[0][1]*p[2][1]*p[5][0] - 2*p[0][1]*p[3][1]*p[5][0] + 2*p[0][1]*p[4][1]*p[5][0] - p[2][1]*p[4][1]*p[5][0] + 6*p[3][1]*p[4][1]*p[5][0] + 2*p[0][1]*p[2][0]*p[5][1] - 8*p[2][0]*p[2][1]*p[5][1] + 2*p[0][1]*p[3][0]*p[5][1] - 2*p[2][1]*p[3][0]*p[5][1] + 2*p[2][0]*p[3][1]*p[5][1] + 4*p[3][0]*p[3][1]*p[5][1] - 2*p[0][1]*p[4][0]*p[5][1] + 4*p[2][1]*p[4][0]*p[5][1] - 6*p[3][1]*p[4][0]*p[5][1] - 3*p[2][0]*p[4][1]*p[5][1] + 5*p[4][0]*p[4][1]*p[5][1] + 4*p[2][1]*p[5][0]*p[5][1] + 2*p[3][1]*p[5][0]*p[5][1] - 5*p[4][1]*p[5][0]*p[5][1] + p[1][1]*(-4*p[0][1]*p[3][0] - 2*p[3][0]*p[3][1] + 2*p[0][1]*p[4][0] - p[2][1]*p[4][0] + 2*p[3][0]*p[4][1] - 4*p[4][0]*p[4][1] + 2*p[0][1]*p[5][0] + p[2][1]*p[5][0] + 2*p[3][1]*p[5][0] - 4*p[4][1]*p[5][0] + p[2][0]*(9*p[2][1] + 2*p[3][1] - 2*p[4][1] - 3*p[5][1]) + p[4][0]*p[5][1] - p[5][0]*p[5][1] + p[1][0]*(-9*p[2][1] - 2*p[3][1] + 8*p[4][1] + 3*p[5][1])) + p[1][0]*(-9*pow(p[2][1], 2) + 2*pow(p[3][1], 2) + 4*pow(p[4][1], 2) + pow(p[5][1], 2) - 2*p[3][1]*p[4][1] - 2*p[3][1]*p[5][1] + 3*p[4][1]*p[5][1] + p[2][1]*(-2*p[3][1] + 3*p[4][1] + 2*p[5][1]) + p[0][1]*(4*p[3][1] - 2*(p[4][1] + p[5][1])))) + 3*pow(p[1][1], 2)*p[0][0]*p[5][2] - 8*pow(p[2][1], 2)*p[0][0]*p[5][2] + 4*pow(p[3][1], 2)*p[0][0]*p[5][2] + 5*pow(p[4][1], 2)*p[0][0]*p[5][2] + 8*pow(p[2][1], 2)*p[1][0]*p[5][2] - 2*pow(p[3][1], 2)*p[1][0]*p[5][2] - 8*pow(p[4][1], 2)*p[1][0]*p[5][2] - 6*pow(p[1][1], 2)*p[2][0]*p[5][2] - 2*pow(p[3][1], 2)*p[2][0]*p[5][2] - 6*pow(p[4][1], 2)*p[2][0]*p[5][2] - p[0][0]*p[1][1]*p[2][1]*p[5][2] + 6*p[1][0]*p[1][1]*p[2][1]*p[5][2] - 8*p[1][1]*p[2][0]*p[2][1]*p[5][2] - pow(p[1][1], 2)*p[3][0]*p[5][2] - 4*pow(p[2][1], 2)*p[3][0]*p[5][2] + 9*pow(p[4][1], 2)*p[3][0]*p[5][2] - 3*p[1][1]*p[2][1]*p[3][0]*p[5][2] - 2*p[0][0]*p[1][1]*p[3][1]*p[5][2] + p[1][0]*p[1][1]*p[3][1]*p[5][2] + 4*p[1][1]*p[2][0]*p[3][1]*p[5][2] - p[1][0]*p[2][1]*p[3][1]*p[5][2] + 4*p[2][0]*p[2][1]*p[3][1]*p[5][2] + 2*p[1][1]*p[3][0]*p[3][1]*p[5][2] + 2*p[2][1]*p[3][0]*p[3][1]*p[5][2] + 4*pow(p[1][1], 2)*p[4][0]*p[5][2] + 4*pow(p[2][1], 2)*p[4][0]*p[5][2] + 6*p[1][1]*p[2][1]*p[4][0]*p[5][2] - 5*p[1][1]*p[3][1]*p[4][0]*p[5][2] - 5*p[2][1]*p[3][1]*p[4][0]*p[5][2] + 4*p[0][0]*p[1][1]*p[4][1]*p[5][2] - 4*p[1][0]*p[1][1]*p[4][1]*p[5][2] - 6*p[1][1]*p[2][0]*p[4][1]*p[5][2] + p[0][0]*p[2][1]*p[4][1]*p[5][2] - 4*p[2][0]*p[2][1]*p[4][1]*p[5][2] - 2*p[1][1]*p[3][0]*p[4][1]*p[5][2] - 3*p[2][1]*p[3][0]*p[4][1]*p[5][2] - 6*p[0][0]*p[3][1]*p[4][1]*p[5][2] + 7*p[1][0]*p[3][1]*p[4][1]*p[5][2] + 8*p[2][0]*p[3][1]*p[4][1]*p[5][2] + 8*p[1][1]*p[4][0]*p[4][1]*p[5][2] + 6*p[2][1]*p[4][0]*p[4][1]*p[5][2] - 9*p[3][1]*p[4][0]*p[4][1]*p[5][2] + p[0][0]*p[1][1]*p[5][1]*p[5][2] - 4*p[1][1]*p[2][0]*p[5][1]*p[5][2] - 4*p[0][0]*p[2][1]*p[5][1]*p[5][2] + 4*p[1][0]*p[2][1]*p[5][1]*p[5][2] - 3*p[1][1]*p[3][0]*p[5][1]*p[5][2] - 8*p[2][1]*p[3][0]*p[5][1]*p[5][2] - 2*p[0][0]*p[3][1]*p[5][1]*p[5][2] + 3*p[1][0]*p[3][1]*p[5][1]*p[5][2] + 8*p[2][0]*p[3][1]*p[5][1]*p[5][2] + 6*p[1][1]*p[4][0]*p[5][1]*p[5][2] + 8*p[2][1]*p[4][0]*p[5][1]*p[5][2] - 9*p[3][1]*p[4][0]*p[5][1]*p[5][2] + 5*p[0][0]*p[4][1]*p[5][1]*p[5][2] - 6*p[1][0]*p[4][1]*p[5][1]*p[5][2] - 8*p[2][0]*p[4][1]*p[5][1]*p[5][2] + 9*p[3][0]*p[4][1]*p[5][1]*p[5][2] + 2*pow(p[0][1], 2)*(-2*p[1][0]*p[3][2] + 2*p[2][0]*p[3][2] - p[3][2]*p[4][0] + p[1][0]*p[4][2] - p[2][0]*p[4][2] + p[3][0]*p[4][2] + p[1][2]*(2*p[3][0] - p[4][0] - p[5][0]) + p[3][2]*p[5][0] - p[4][2]*p[5][0] + p[2][2]*(-2*p[3][0] + p[4][0] + p[5][0]) + p[1][0]*p[5][2] - p[2][0]*p[5][2] - p[3][0]*p[5][2] + p[4][0]*p[5][2]) + p[0][1]*(9*p[1][0]*p[2][1]*p[2][2] + 2*p[2][1]*p[2][2]*p[3][0] + 4*p[0][0]*p[2][2]*p[3][1] - 4*p[1][0]*p[2][2]*p[3][1] - 2*p[2][2]*p[3][0]*p[3][1] - 4*p[0][0]*p[2][1]*p[3][2] + 6*p[1][0]*p[2][1]*p[3][2] - 2*p[2][0]*p[2][1]*p[3][2] - 2*p[1][0]*p[3][1]*p[3][2] + 2*p[2][0]*p[3][1]*p[3][2] - 3*p[2][1]*p[2][2]*p[4][0] + 2*p[2][1]*p[3][2]*p[4][0] - 4*p[3][1]*p[3][2]*p[4][0] - 2*p[0][0]*p[2][2]*p[4][1] + 5*p[1][0]*p[2][2]*p[4][1] + 2*p[2][2]*p[3][0]*p[4][1] + 2*p[0][0]*p[3][2]*p[4][1] - 2*p[2][0]*p[3][2]*p[4][1] - p[2][2]*p[4][0]*p[4][1] + 2*p[3][2]*p[4][0]*p[4][1] + 2*p[0][0]*p[2][1]*p[4][2] - 8*p[1][0]*p[2][1]*p[4][2] + 3*p[2][0]*p[2][1]*p[4][2] - 2*p[2][1]*p[3][0]*p[4][2] - 2*p[0][0]*p[3][1]*p[4][2] + 2*p[1][0]*p[3][1]*p[4][2] + 4*p[3][0]*p[3][1]*p[4][2] - 4*p[1][0]*p[4][1]*p[4][2] + p[2][0]*p[4][1]*p[4][2] - 2*p[3][0]*p[4][1]*p[4][2] - 8*p[2][1]*p[2][2]*p[5][0] + 2*p[2][2]*p[3][1]*p[5][0] - 2*p[2][1]*p[3][2]*p[5][0] + 4*p[3][1]*p[3][2]*p[5][0] - 4*p[2][2]*p[4][1]*p[5][0] - 2*p[3][2]*p[4][1]*p[5][0] + 5*p[2][1]*p[4][2]*p[5][0] - 4*p[3][1]*p[4][2]*p[5][0] + 5*p[4][1]*p[4][2]*p[5][0] - 2*p[0][0]*p[2][2]*p[5][1] + 5*p[1][0]*p[2][2]*p[5][1] - 2*p[0][0]*p[3][2]*p[5][1] + 2*p[1][0]*p[3][2]*p[5][1] + p[2][2]*p[4][0]*p[5][1] + 2*p[3][2]*p[4][0]*p[5][1] + 2*p[0][0]*p[4][2]*p[5][1] - 4*p[1][0]*p[4][2]*p[5][1] - p[2][0]*p[4][2]*p[5][1] - 2*p[3][0]*p[4][2]*p[5][1] - 4*p[2][2]*p[5][0]*p[5][1] - 2*p[3][2]*p[5][0]*p[5][1] + 5*p[4][2]*p[5][0]*p[5][1] + p[1][2]*(-4*p[0][0]*p[3][1] + 2*p[3][0]*p[3][1] - 2*p[3][1]*p[4][0] + 2*p[0][0]*p[4][1] + 4*p[4][0]*p[4][1] - p[4][1]*p[5][0] + p[2][1]*(-6*p[3][0] + 8*p[4][0] + 7*p[5][0]) + 2*p[0][0]*p[5][1] - 2*p[3][0]*p[5][1] + 4*p[4][0]*p[5][1] + p[5][0]*p[5][1] - p[2][0]*(9*p[2][1] - 4*p[3][1] + 5*(p[4][1] + p[5][1]))) + 2*p[0][0]*p[2][1]*p[5][2] - 7*p[1][0]*p[2][1]*p[5][2] + 8*p[2][0]*p[2][1]*p[5][2] + 2*p[2][1]*p[3][0]*p[5][2] + 2*p[0][0]*p[3][1]*p[5][2] - 2*p[2][0]*p[3][1]*p[5][2] - 4*p[3][0]*p[3][1]*p[5][2] - 5*p[2][1]*p[4][0]*p[5][2] + 4*p[3][1]*p[4][0]*p[5][2] - 2*p[0][0]*p[4][1]*p[5][2] + p[1][0]*p[4][1]*p[5][2] + 4*p[2][0]*p[4][1]*p[5][2] + 2*p[3][0]*p[4][1]*p[5][2] - 5*p[4][0]*p[4][1]*p[5][2] - p[1][0]*p[5][1]*p[5][2] + 4*p[2][0]*p[5][1]*p[5][2] + 2*p[3][0]*p[5][1]*p[5][2] - 5*p[4][0]*p[5][1]*p[5][2] + p[1][1]*(6*p[2][2]*p[3][0] + 4*p[0][0]*p[3][2] - 6*p[2][0]*p[3][2] - 7*p[2][2]*p[4][0] + 2*p[3][2]*p[4][0] - 2*p[0][0]*p[4][2] + 7*p[2][0]*p[4][2] - 2*p[3][0]*p[4][2] - 8*p[2][2]*p[5][0] - 2*p[3][2]*p[5][0] + 5*p[4][2]*p[5][0] + p[1][2]*(-9*p[2][0] - 2*p[3][0] + 8*p[4][0] + 3*p[5][0]) + p[1][0]*(9*p[2][2] + 2*p[3][2] - 8*p[4][2] - 3*p[5][2]) - 2*p[0][0]*p[5][2] + 8*p[2][0]*p[5][2] + 2*p[3][0]*p[5][2] - 5*p[4][0]*p[5][2])))/72;

	    result[3][0]=
	      (-9*pow(p[2][2], 2)*p[0][0]*p[1][1] + 2*pow(p[3][2], 2)*p[0][0]*p[1][1] + 4*pow(p[4][2], 2)*p[0][0]*p[1][1] + pow(p[5][2], 2)*p[0][0]*p[1][1] - 2*pow(p[3][2], 2)*p[1][1]*p[2][0] - 4*pow(p[4][2], 2)*p[1][1]*p[2][0] - 4*pow(p[5][2], 2)*p[1][1]*p[2][0] + 9*pow(p[1][2], 2)*p[0][0]*p[2][1] - 2*pow(p[3][2], 2)*p[0][0]*p[2][1] - pow(p[4][2], 2)*p[0][0]*p[2][1] - 4*pow(p[5][2], 2)*p[0][0]*p[2][1] + 2*pow(p[3][2], 2)*p[1][0]*p[2][1] + 4*pow(p[4][2], 2)*p[1][0]*p[2][1] + 4*pow(p[5][2], 2)*p[1][0]*p[2][1] - 9*p[0][0]*p[1][1]*p[1][2]*p[2][2] + 9*p[0][0]*p[1][2]*p[2][1]*p[2][2] - 5*pow(p[2][2], 2)*p[1][1]*p[3][0] + 8*pow(p[4][2], 2)*p[1][1]*p[3][0] - 3*pow(p[5][2], 2)*p[1][1]*p[3][0] + 5*pow(p[1][2], 2)*p[2][1]*p[3][0] + 3*pow(p[4][2], 2)*p[2][1]*p[3][0] - 8*pow(p[5][2], 2)*p[2][1]*p[3][0] - 5*p[1][1]*p[1][2]*p[2][2]*p[3][0] + 5*p[1][2]*p[2][1]*p[2][2]*p[3][0] + 2*pow(p[1][2], 2)*p[0][0]*p[3][1] - 2*pow(p[2][2], 2)*p[0][0]*p[3][1] + 2*pow(p[4][2], 2)*p[0][0]*p[3][1] - 2*pow(p[5][2], 2)*p[0][0]*p[3][1] + 5*pow(p[2][2], 2)*p[1][0]*p[3][1] - 8*pow(p[4][2], 2)*p[1][0]*p[3][1] + 3*pow(p[5][2], 2)*p[1][0]*p[3][1] - 5*pow(p[1][2], 2)*p[2][0]*p[3][1] - 3*pow(p[4][2], 2)*p[2][0]*p[3][1] + 8*pow(p[5][2], 2)*p[2][0]*p[3][1] + 5*p[1][0]*p[1][2]*p[2][2]*p[3][1] - 5*p[1][2]*p[2][0]*p[2][2]*p[3][1] - 2*p[0][0]*p[1][1]*p[1][2]*p[3][2] + 5*p[1][1]*p[1][2]*p[2][0]*p[3][2] + 2*p[0][0]*p[1][2]*p[2][1]*p[3][2] - 5*p[1][0]*p[1][2]*p[2][1]*p[3][2] - 2*p[0][0]*p[1][1]*p[2][2]*p[3][2] + 5*p[1][1]*p[2][0]*p[2][2]*p[3][2] + 2*p[0][0]*p[2][1]*p[2][2]*p[3][2] - 5*p[1][0]*p[2][1]*p[2][2]*p[3][2] - 2*p[1][2]*p[2][1]*p[3][0]*p[3][2] + 2*p[1][1]*p[2][2]*p[3][0]*p[3][2] - 2*p[0][0]*p[1][2]*p[3][1]*p[3][2] + 2*p[1][2]*p[2][0]*p[3][1]*p[3][2] + 2*p[0][0]*p[2][2]*p[3][1]*p[3][2] - 2*p[1][0]*p[2][2]*p[3][1]*p[3][2] + 6*pow(p[2][2], 2)*p[1][1]*p[4][0] + 2*pow(p[3][2], 2)*p[1][1]*p[4][0] + 6*pow(p[5][2], 2)*p[1][1]*p[4][0] - 8*pow(p[1][2], 2)*p[2][1]*p[4][0] + 2*pow(p[3][2], 2)*p[2][1]*p[4][0] + 8*pow(p[5][2], 2)*p[2][1]*p[4][0] + 8*p[1][1]*p[1][2]*p[2][2]*p[4][0] - 6*p[1][2]*p[2][1]*p[2][2]*p[4][0] + 4*pow(p[1][2], 2)*p[3][1]*p[4][0] + pow(p[2][2], 2)*p[3][1]*p[4][0] - 9*pow(p[5][2], 2)*p[3][1]*p[4][0] + 3*p[1][2]*p[2][2]*p[3][1]*p[4][0] - 4*p[1][1]*p[1][2]*p[3][2]*p[4][0] + p[1][2]*p[2][1]*p[3][2]*p[4][0] - 4*p[1][1]*p[2][2]*p[3][2]*p[4][0] - p[2][1]*p[2][2]*p[3][2]*p[4][0] - 2*p[1][2]*p[3][1]*p[3][2]*p[4][0] - 2*p[2][2]*p[3][1]*p[3][2]*p[4][0] - 8*pow(p[1][2], 2)*p[0][0]*p[4][1] + 3*pow(p[2][2], 2)*p[0][0]*p[4][1] + 4*pow(p[3][2], 2)*p[0][0]*p[4][1] + 5*pow(p[5][2], 2)*p[0][0]*p[4][1] - 6*pow(p[2][2], 2)*p[1][0]*p[4][1] - 2*pow(p[3][2], 2)*p[1][0]*p[4][1] - 6*pow(p[5][2], 2)*p[1][0]*p[4][1] + 8*pow(p[1][2], 2)*p[2][0]*p[4][1] - 2*pow(p[3][2], 2)*p[2][0]*p[4][1] - 8*pow(p[5][2], 2)*p[2][0]*p[4][1] - p[0][0]*p[1][2]*p[2][2]*p[4][1] - 8*p[1][0]*p[1][2]*p[2][2]*p[4][1] + 6*p[1][2]*p[2][0]*p[2][2]*p[4][1] - 4*pow(p[1][2], 2)*p[3][0]*p[4][1] - pow(p[2][2], 2)*p[3][0]*p[4][1] + 9*pow(p[5][2], 2)*p[3][0]*p[4][1] - 3*p[1][2]*p[2][2]*p[3][0]*p[4][1] + 4*p[1][0]*p[1][2]*p[3][2]*p[4][1] - p[1][2]*p[2][0]*p[3][2]*p[4][1] - 2*p[0][0]*p[2][2]*p[3][2]*p[4][1] + 4*p[1][0]*p[2][2]*p[3][2]*p[4][1] + p[2][0]*p[2][2]*p[3][2]*p[4][1] + 2*p[1][2]*p[3][0]*p[3][2]*p[4][1] + 2*p[2][2]*p[3][0]*p[3][2]*p[4][1] + 8*p[0][0]*p[1][1]*p[1][2]*p[4][2] - 8*p[1][1]*p[1][2]*p[2][0]*p[4][2] - 2*p[0][0]*p[1][2]*p[2][1]*p[4][2] + 8*p[1][0]*p[1][2]*p[2][1]*p[4][2] + 3*p[0][0]*p[1][1]*p[2][2]*p[4][2] - 6*p[1][1]*p[2][0]*p[2][2]*p[4][2] - 3*p[0][0]*p[2][1]*p[2][2]*p[4][2] + 6*p[1][0]*p[2][1]*p[2][2]*p[4][2] + 4*p[1][1]*p[1][2]*p[3][0]*p[4][2] + 4*p[1][2]*p[2][1]*p[3][0]*p[4][2] - p[1][1]*p[2][2]*p[3][0]*p[4][2] + p[2][1]*p[2][2]*p[3][0]*p[4][2] + 2*p[0][0]*p[1][2]*p[3][1]*p[4][2] - 4*p[1][0]*p[1][2]*p[3][1]*p[4][2] - 4*p[1][2]*p[2][0]*p[3][1]*p[4][2] + p[1][0]*p[2][2]*p[3][1]*p[4][2] - p[2][0]*p[2][2]*p[3][1]*p[4][2] - 2*p[0][0]*p[1][1]*p[3][2]*p[4][2] + 5*p[1][1]*p[2][0]*p[3][2]*p[4][2] + 2*p[0][0]*p[2][1]*p[3][2]*p[4][2] - 5*p[1][0]*p[2][1]*p[3][2]*p[4][2] - 2*p[1][1]*p[3][0]*p[3][2]*p[4][2] - 2*p[2][1]*p[3][0]*p[3][2]*p[4][2] - 4*p[0][0]*p[3][1]*p[3][2]*p[4][2] + 2*p[1][0]*p[3][1]*p[3][2]*p[4][2] + 2*p[2][0]*p[3][1]*p[3][2]*p[4][2] - 4*p[1][2]*p[2][1]*p[4][0]*p[4][2] + 4*p[1][1]*p[2][2]*p[4][0]*p[4][2] + 8*p[1][2]*p[3][1]*p[4][0]*p[4][2] + 3*p[2][2]*p[3][1]*p[4][0]*p[4][2] - 8*p[1][1]*p[3][2]*p[4][0]*p[4][2] - 3*p[2][1]*p[3][2]*p[4][0]*p[4][2] - 4*p[0][0]*p[1][2]*p[4][1]*p[4][2] + 4*p[1][2]*p[2][0]*p[4][1]*p[4][2] + p[0][0]*p[2][2]*p[4][1]*p[4][2] - 4*p[1][0]*p[2][2]*p[4][1]*p[4][2] - 8*p[1][2]*p[3][0]*p[4][1]*p[4][2] - 3*p[2][2]*p[3][0]*p[4][1]*p[4][2] - 2*p[0][0]*p[3][2]*p[4][1]*p[4][2] + 8*p[1][0]*p[3][2]*p[4][1]*p[4][2] + 3*p[2][0]*p[3][2]*p[4][1]*p[4][2] + 8*pow(p[2][2], 2)*p[1][1]*p[5][0] - 2*pow(p[3][2], 2)*p[1][1]*p[5][0] - 8*pow(p[4][2], 2)*p[1][1]*p[5][0] - 6*pow(p[1][2], 2)*p[2][1]*p[5][0] - 2*pow(p[3][2], 2)*p[2][1]*p[5][0] - 6*pow(p[4][2], 2)*p[2][1]*p[5][0] + 6*p[1][1]*p[1][2]*p[2][2]*p[5][0] - 8*p[1][2]*p[2][1]*p[2][2]*p[5][0] - pow(p[1][2], 2)*p[3][1]*p[5][0] - 4*pow(p[2][2], 2)*p[3][1]*p[5][0] + 9*pow(p[4][2], 2)*p[3][1]*p[5][0] - 3*p[1][2]*p[2][2]*p[3][1]*p[5][0] + p[1][1]*p[1][2]*p[3][2]*p[5][0] + 4*p[1][2]*p[2][1]*p[3][2]*p[5][0] - p[1][1]*p[2][2]*p[3][2]*p[5][0] + 4*p[2][1]*p[2][2]*p[3][2]*p[5][0] + 2*p[1][2]*p[3][1]*p[3][2]*p[5][0] + 2*p[2][2]*p[3][1]*p[3][2]*p[5][0] + 4*pow(p[1][2], 2)*p[4][1]*p[5][0] + 4*pow(p[2][2], 2)*p[4][1]*p[5][0] + 6*p[1][2]*p[2][2]*p[4][1]*p[5][0] - 5*p[1][2]*p[3][2]*p[4][1]*p[5][0] - 5*p[2][2]*p[3][2]*p[4][1]*p[5][0] - 4*p[1][1]*p[1][2]*p[4][2]*p[5][0] - 6*p[1][2]*p[2][1]*p[4][2]*p[5][0] - 4*p[2][1]*p[2][2]*p[4][2]*p[5][0] - 2*p[1][2]*p[3][1]*p[4][2]*p[5][0] - 3*p[2][2]*p[3][1]*p[4][2]*p[5][0] + 7*p[1][1]*p[3][2]*p[4][2]*p[5][0] + 8*p[2][1]*p[3][2]*p[4][2]*p[5][0] + 8*p[1][2]*p[4][1]*p[4][2]*p[5][0] + 6*p[2][2]*p[4][1]*p[4][2]*p[5][0] - 9*p[3][2]*p[4][1]*p[4][2]*p[5][0] - 3*pow(p[1][2], 2)*p[0][0]*p[5][1] + 8*pow(p[2][2], 2)*p[0][0]*p[5][1] - 4*pow(p[3][2], 2)*p[0][0]*p[5][1] - 5*pow(p[4][2], 2)*p[0][0]*p[5][1] - 8*pow(p[2][2], 2)*p[1][0]*p[5][1] + 2*pow(p[3][2], 2)*p[1][0]*p[5][1] + 8*pow(p[4][2], 2)*p[1][0]*p[5][1] + 6*pow(p[1][2], 2)*p[2][0]*p[5][1] + 2*pow(p[3][2], 2)*p[2][0]*p[5][1] + 6*pow(p[4][2], 2)*p[2][0]*p[5][1] + p[0][0]*p[1][2]*p[2][2]*p[5][1] - 6*p[1][0]*p[1][2]*p[2][2]*p[5][1] + 8*p[1][2]*p[2][0]*p[2][2]*p[5][1] + pow(p[1][2], 2)*p[3][0]*p[5][1] + 4*pow(p[2][2], 2)*p[3][0]*p[5][1] - 9*pow(p[4][2], 2)*p[3][0]*p[5][1] + 3*p[1][2]*p[2][2]*p[3][0]*p[5][1] + 2*p[0][0]*p[1][2]*p[3][2]*p[5][1] - p[1][0]*p[1][2]*p[3][2]*p[5][1] - 4*p[1][2]*p[2][0]*p[3][2]*p[5][1] + p[1][0]*p[2][2]*p[3][2]*p[5][1] - 4*p[2][0]*p[2][2]*p[3][2]*p[5][1] - 2*p[1][2]*p[3][0]*p[3][2]*p[5][1] - 2*p[2][2]*p[3][0]*p[3][2]*p[5][1] - 4*pow(p[1][2], 2)*p[4][0]*p[5][1] - 4*pow(p[2][2], 2)*p[4][0]*p[5][1] - 6*p[1][2]*p[2][2]*p[4][0]*p[5][1] + 5*p[1][2]*p[3][2]*p[4][0]*p[5][1] + 5*p[2][2]*p[3][2]*p[4][0]*p[5][1] - 4*p[0][0]*p[1][2]*p[4][2]*p[5][1] + 4*p[1][0]*p[1][2]*p[4][2]*p[5][1] + 6*p[1][2]*p[2][0]*p[4][2]*p[5][1] - p[0][0]*p[2][2]*p[4][2]*p[5][1] + 4*p[2][0]*p[2][2]*p[4][2]*p[5][1] + 2*p[1][2]*p[3][0]*p[4][2]*p[5][1] + 3*p[2][2]*p[3][0]*p[4][2]*p[5][1] + 6*p[0][0]*p[3][2]*p[4][2]*p[5][1] - 7*p[1][0]*p[3][2]*p[4][2]*p[5][1] - 8*p[2][0]*p[3][2]*p[4][2]*p[5][1] - 8*p[1][2]*p[4][0]*p[4][2]*p[5][1] - 6*p[2][2]*p[4][0]*p[4][2]*p[5][1] + 9*p[3][2]*p[4][0]*p[4][2]*p[5][1] - 2*pow(p[0][2], 2)*(-2*p[1][0]*p[3][1] + 2*p[2][0]*p[3][1] - p[3][1]*p[4][0] + p[1][0]*p[4][1] - p[2][0]*p[4][1] + p[3][0]*p[4][1] + p[1][1]*(2*p[3][0] - p[4][0] - p[5][0]) + p[3][1]*p[5][0] - p[4][1]*p[5][0] + p[2][1]*(-2*p[3][0] + p[4][0] + p[5][0]) + p[1][0]*p[5][1] - p[2][0]*p[5][1] - p[3][0]*p[5][1] + p[4][0]*p[5][1]) + 3*p[0][0]*p[1][1]*p[1][2]*p[5][2] - 6*p[1][1]*p[1][2]*p[2][0]*p[5][2] - 3*p[0][0]*p[1][2]*p[2][1]*p[5][2] + 6*p[1][0]*p[1][2]*p[2][1]*p[5][2] + 2*p[0][0]*p[1][1]*p[2][2]*p[5][2] - 8*p[1][1]*p[2][0]*p[2][2]*p[5][2] - 8*p[0][0]*p[2][1]*p[2][2]*p[5][2] + 8*p[1][0]*p[2][1]*p[2][2]*p[5][2] - p[1][1]*p[1][2]*p[3][0]*p[5][2] + p[1][2]*p[2][1]*p[3][0]*p[5][2] - 4*p[1][1]*p[2][2]*p[3][0]*p[5][2] - 4*p[2][1]*p[2][2]*p[3][0]*p[5][2] + p[1][0]*p[1][2]*p[3][1]*p[5][2] - p[1][2]*p[2][0]*p[3][1]*p[5][2] - 2*p[0][0]*p[2][2]*p[3][1]*p[5][2] + 4*p[1][0]*p[2][2]*p[3][1]*p[5][2] + 4*p[2][0]*p[2][2]*p[3][1]*p[5][2] - 2*p[0][0]*p[1][1]*p[3][2]*p[5][2] + 5*p[1][1]*p[2][0]*p[3][2]*p[5][2] + 2*p[0][0]*p[2][1]*p[3][2]*p[5][2] - 5*p[1][0]*p[2][1]*p[3][2]*p[5][2] + 2*p[1][1]*p[3][0]*p[3][2]*p[5][2] + 2*p[2][1]*p[3][0]*p[3][2]*p[5][2] + 4*p[0][0]*p[3][1]*p[3][2]*p[5][2] - 2*p[1][0]*p[3][1]*p[3][2]*p[5][2] - 2*p[2][0]*p[3][1]*p[3][2]*p[5][2] + 4*p[1][1]*p[1][2]*p[4][0]*p[5][2] + 6*p[1][1]*p[2][2]*p[4][0]*p[5][2] + 4*p[2][1]*p[2][2]*p[4][0]*p[5][2] + 3*p[1][2]*p[3][1]*p[4][0]*p[5][2] + 2*p[2][2]*p[3][1]*p[4][0]*p[5][2] - 8*p[1][1]*p[3][2]*p[4][0]*p[5][2] - 7*p[2][1]*p[3][2]*p[4][0]*p[5][2] + p[0][0]*p[1][2]*p[4][1]*p[5][2] - 4*p[1][0]*p[1][2]*p[4][1]*p[5][2] + 4*p[0][0]*p[2][2]*p[4][1]*p[5][2] - 6*p[1][0]*p[2][2]*p[4][1]*p[5][2] - 4*p[2][0]*p[2][2]*p[4][1]*p[5][2] - 3*p[1][2]*p[3][0]*p[4][1]*p[5][2] - 2*p[2][2]*p[3][0]*p[4][1]*p[5][2] - 6*p[0][0]*p[3][2]*p[4][1]*p[5][2] + 8*p[1][0]*p[3][2]*p[4][1]*p[5][2] + 7*p[2][0]*p[3][2]*p[4][1]*p[5][2] + 3*p[0][0]*p[1][1]*p[4][2]*p[5][2] - 6*p[1][1]*p[2][0]*p[4][2]*p[5][2] - 3*p[0][0]*p[2][1]*p[4][2]*p[5][2] + 6*p[1][0]*p[2][1]*p[4][2]*p[5][2] + p[1][1]*p[3][0]*p[4][2]*p[5][2] - p[2][1]*p[3][0]*p[4][2]*p[5][2] - p[1][0]*p[3][1]*p[4][2]*p[5][2] + p[2][0]*p[3][1]*p[4][2]*p[5][2] + 8*p[1][1]*p[4][0]*p[4][2]*p[5][2] + 6*p[2][1]*p[4][0]*p[4][2]*p[5][2] - 9*p[3][1]*p[4][0]*p[4][2]*p[5][2] + 5*p[0][0]*p[4][1]*p[4][2]*p[5][2] - 8*p[1][0]*p[4][1]*p[4][2]*p[5][2] - 6*p[2][0]*p[4][1]*p[4][2]*p[5][2] + 9*p[3][0]*p[4][1]*p[4][2]*p[5][2] - 4*p[1][2]*p[2][1]*p[5][0]*p[5][2] + 4*p[1][1]*p[2][2]*p[5][0]*p[5][2] - 3*p[1][2]*p[3][1]*p[5][0]*p[5][2] - 8*p[2][2]*p[3][1]*p[5][0]*p[5][2] + 3*p[1][1]*p[3][2]*p[5][0]*p[5][2] + 8*p[2][1]*p[3][2]*p[5][0]*p[5][2] + 6*p[1][2]*p[4][1]*p[5][0]*p[5][2] + 8*p[2][2]*p[4][1]*p[5][0]*p[5][2] - 9*p[3][2]*p[4][1]*p[5][0]*p[5][2] - 6*p[1][1]*p[4][2]*p[5][0]*p[5][2] - 8*p[2][1]*p[4][2]*p[5][0]*p[5][2] + 9*p[3][1]*p[4][2]*p[5][0]*p[5][2] - p[0][0]*p[1][2]*p[5][1]*p[5][2] + 4*p[1][2]*p[2][0]*p[5][1]*p[5][2] + 4*p[0][0]*p[2][2]*p[5][1]*p[5][2] - 4*p[1][0]*p[2][2]*p[5][1]*p[5][2] + 3*p[1][2]*p[3][0]*p[5][1]*p[5][2] + 8*p[2][2]*p[3][0]*p[5][1]*p[5][2] + 2*p[0][0]*p[3][2]*p[5][1]*p[5][2] - 3*p[1][0]*p[3][2]*p[5][1]*p[5][2] - 8*p[2][0]*p[3][2]*p[5][1]*p[5][2] - 6*p[1][2]*p[4][0]*p[5][1]*p[5][2] - 8*p[2][2]*p[4][0]*p[5][1]*p[5][2] + 9*p[3][2]*p[4][0]*p[5][1]*p[5][2] - 5*p[0][0]*p[4][2]*p[5][1]*p[5][2] + 6*p[1][0]*p[4][2]*p[5][1]*p[5][2] + 8*p[2][0]*p[4][2]*p[5][1]*p[5][2] - 9*p[3][0]*p[4][2]*p[5][1]*p[5][2] + p[0][1]*(2*pow(p[3][2], 2)*p[2][0] + pow(p[4][2], 2)*p[2][0] + 4*pow(p[5][2], 2)*p[2][0] + 2*pow(p[2][2], 2)*p[3][0] - 2*pow(p[4][2], 2)*p[3][0] + 2*pow(p[5][2], 2)*p[3][0] - 2*p[2][0]*p[2][2]*p[3][2] - 2*p[2][2]*p[3][0]*p[3][2] - 3*pow(p[2][2], 2)*p[4][0] - 4*pow(p[3][2], 2)*p[4][0] - 5*pow(p[5][2], 2)*p[4][0] + 2*p[2][2]*p[3][2]*p[4][0] + 3*p[2][0]*p[2][2]*p[4][2] - 2*p[2][0]*p[3][2]*p[4][2] + 4*p[3][0]*p[3][2]*p[4][2] - p[2][2]*p[4][0]*p[4][2] + 2*p[3][2]*p[4][0]*p[4][2] - 8*pow(p[2][2], 2)*p[5][0] + 4*pow(p[3][2], 2)*p[5][0] + 5*pow(p[4][2], 2)*p[5][0] + p[2][2]*p[4][2]*p[5][0] - 6*p[3][2]*p[4][2]*p[5][0] + pow(p[1][2], 2)*(-9*p[2][0] - 2*p[3][0] + 8*p[4][0] + 3*p[5][0]) + 8*p[2][0]*p[2][2]*p[5][2] + 2*p[2][2]*p[3][0]*p[5][2] - 2*p[2][0]*p[3][2]*p[5][2] - 4*p[3][0]*p[3][2]*p[5][2] - 4*p[2][2]*p[4][0]*p[5][2] + 6*p[3][2]*p[4][0]*p[5][2] + 3*p[2][0]*p[4][2]*p[5][2] - 5*p[4][0]*p[4][2]*p[5][2] - 4*p[2][2]*p[5][0]*p[5][2] - 2*p[3][2]*p[5][0]*p[5][2] + 5*p[4][2]*p[5][0]*p[5][2] + p[1][0]*(9*pow(p[2][2], 2) - 2*pow(p[3][2], 2) - 4*pow(p[4][2], 2) - pow(p[5][2], 2) + p[2][2]*(2*p[3][2] - 3*p[4][2] - 2*p[5][2]) - 3*p[4][2]*p[5][2] + 2*p[3][2]*(p[4][2] + p[5][2])) + p[1][2]*(2*p[3][0]*p[3][2] + p[2][2]*p[4][0] - 2*p[3][0]*p[4][2] + 4*p[4][0]*p[4][2] - p[2][2]*p[5][0] - 2*p[3][2]*p[5][0] + 4*p[4][2]*p[5][0] + p[1][0]*(9*p[2][2] + 2*p[3][2] - 8*p[4][2] - 3*p[5][2]) - p[4][0]*p[5][2] + p[5][0]*p[5][2] + p[2][0]*(-9*p[2][2] - 2*p[3][2] + 2*p[4][2] + 3*p[5][2]))) + p[0][2]*(4*p[0][1]*p[1][2]*p[3][0] - 6*p[1][2]*p[2][1]*p[3][0] - 4*p[0][1]*p[2][2]*p[3][0] - 2*p[2][1]*p[2][2]*p[3][0] - 4*p[0][0]*p[1][2]*p[3][1] + 6*p[1][2]*p[2][0]*p[3][1] + 4*p[0][0]*p[2][2]*p[3][1] + 2*p[2][0]*p[2][2]*p[3][1] + 4*p[0][1]*p[2][0]*p[3][2] - 4*p[0][0]*p[2][1]*p[3][2] + 2*p[2][1]*p[3][0]*p[3][2] - 2*p[2][0]*p[3][1]*p[3][2] - 2*p[0][1]*p[1][2]*p[4][0] + 7*p[1][2]*p[2][1]*p[4][0] + 2*p[0][1]*p[2][2]*p[4][0] + 3*p[2][1]*p[2][2]*p[4][0] - 2*p[1][2]*p[3][1]*p[4][0] - 2*p[2][2]*p[3][1]*p[4][0] - 2*p[0][1]*p[3][2]*p[4][0] + 4*p[3][1]*p[3][2]*p[4][0] + 2*p[0][0]*p[1][2]*p[4][1] - 7*p[1][2]*p[2][0]*p[4][1] - 2*p[0][0]*p[2][2]*p[4][1] - 3*p[2][0]*p[2][2]*p[4][1] + 2*p[1][2]*p[3][0]*p[4][1] + 2*p[2][2]*p[3][0]*p[4][1] + 2*p[0][0]*p[3][2]*p[4][1] - 4*p[3][0]*p[3][2]*p[4][1] - 2*p[0][1]*p[2][0]*p[4][2] + 2*p[0][0]*p[2][1]*p[4][2] + 2*p[0][1]*p[3][0]*p[4][2] - 2*p[2][1]*p[3][0]*p[4][2] - 2*p[0][0]*p[3][1]*p[4][2] + 2*p[2][0]*p[3][1]*p[4][2] + p[2][1]*p[4][0]*p[4][2] - 2*p[3][1]*p[4][0]*p[4][2] - p[2][0]*p[4][1]*p[4][2] + 2*p[3][0]*p[4][1]*p[4][2] - 2*p[0][1]*p[1][2]*p[5][0] + 8*p[1][2]*p[2][1]*p[5][0] + 2*p[0][1]*p[2][2]*p[5][0] + 8*p[2][1]*p[2][2]*p[5][0] + 2*p[1][2]*p[3][1]*p[5][0] + 2*p[2][2]*p[3][1]*p[5][0] + 2*p[0][1]*p[3][2]*p[5][0] - 2*p[2][1]*p[3][2]*p[5][0] - 4*p[3][1]*p[3][2]*p[5][0] - 5*p[1][2]*p[4][1]*p[5][0] - 5*p[2][2]*p[4][1]*p[5][0] + 4*p[3][2]*p[4][1]*p[5][0] - 2*p[0][1]*p[4][2]*p[5][0] + 4*p[2][1]*p[4][2]*p[5][0] + 2*p[3][1]*p[4][2]*p[5][0] - 5*p[4][1]*p[4][2]*p[5][0] + 2*p[0][0]*p[1][2]*p[5][1] - 8*p[1][2]*p[2][0]*p[5][1] - 2*p[0][0]*p[2][2]*p[5][1] - 8*p[2][0]*p[2][2]*p[5][1] - 2*p[1][2]*p[3][0]*p[5][1] - 2*p[2][2]*p[3][0]*p[5][1] - 2*p[0][0]*p[3][2]*p[5][1] + 2*p[2][0]*p[3][2]*p[5][1] + 4*p[3][0]*p[3][2]*p[5][1] + 5*p[1][2]*p[4][0]*p[5][1] + 5*p[2][2]*p[4][0]*p[5][1] - 4*p[3][2]*p[4][0]*p[5][1] + 2*p[0][0]*p[4][2]*p[5][1] - 4*p[2][0]*p[4][2]*p[5][1] - 2*p[3][0]*p[4][2]*p[5][1] + 5*p[4][0]*p[4][2]*p[5][1] - 2*p[0][1]*p[2][0]*p[5][2] + 2*p[0][0]*p[2][1]*p[5][2] - 2*p[0][1]*p[3][0]*p[5][2] + 2*p[0][0]*p[3][1]*p[5][2] + 2*p[0][1]*p[4][0]*p[5][2] - p[2][1]*p[4][0]*p[5][2] - 2*p[3][1]*p[4][0]*p[5][2] - 2*p[0][0]*p[4][1]*p[5][2] + p[2][0]*p[4][1]*p[5][2] + 2*p[3][0]*p[4][1]*p[5][2] + 4*p[2][1]*p[5][0]*p[5][2] + 2*p[3][1]*p[5][0]*p[5][2] - 5*p[4][1]*p[5][0]*p[5][2] - 4*p[2][0]*p[5][1]*p[5][2] - 2*p[3][0]*p[5][1]*p[5][2] + 5*p[4][0]*p[5][1]*p[5][2] + p[1][1]*(6*p[2][2]*p[3][0] + 4*p[0][0]*p[3][2] - 2*p[3][0]*p[3][2] - 8*p[2][2]*p[4][0] + 2*p[3][2]*p[4][0] - 2*p[0][0]*p[4][2] - 4*p[4][0]*p[4][2] + p[1][2]*(9*p[2][0] + 2*p[3][0] - 8*p[4][0] - 3*p[5][0]) - 7*p[2][2]*p[5][0] + p[4][2]*p[5][0] - 2*p[0][0]*p[5][2] + 2*p[3][0]*p[5][2] - 4*p[4][0]*p[5][2] - p[5][0]*p[5][2] + p[2][0]*(9*p[2][2] - 4*p[3][2] + 5*(p[4][2] + p[5][2]))) + p[1][0]*(-6*p[2][2]*p[3][1] - 4*p[0][1]*p[3][2] + 2*p[3][1]*p[3][2] + 8*p[2][2]*p[4][1] - 2*p[3][2]*p[4][1] + 2*p[0][1]*p[4][2] + 4*p[4][1]*p[4][2] + 7*p[2][2]*p[5][1] - p[4][2]*p[5][1] + p[1][2]*(-9*p[2][1] - 2*p[3][1] + 8*p[4][1] + 3*p[5][1]) + 2*p[0][1]*p[5][2] - 2*p[3][1]*p[5][2] + 4*p[4][1]*p[5][2] + p[5][1]*p[5][2] - p[2][1]*(9*p[2][2] - 4*p[3][2] + 5*(p[4][2] + p[5][2])))))/72;
	...
	public:
	  ...
	  static result_t apply(const points_t p) {
	    ...
	    result[0][0]=
	      p[0][0]*p[1][2]*p[2][1] - p[0][0]*p[1][1]*p[2][2] - p[1][2]*p[2][1]*p[3][0] + p[1][1]*p[2][2]*p[3][0] - p[0][0]*p[1][2]*p[3][1] + p[1][2]*p[2][0]*p[3][1] + p[0][0]*p[2][2]*p[3][1] - p[1][0]*p[2][2]*p[3][1] + p[0][2]*(p[1][1]*(p[2][0] - p[3][0]) + p[2][1]*p[3][0] - p[2][0]*p[3][1] + p[1][0]*(-p[2][1] + p[3][1])) + p[0][0]*p[1][1]*p[3][2] - p[1][1]*p[2][0]*p[3][2] - p[0][0]*p[2][1]*p[3][2] + p[1][0]*p[2][1]*p[3][2] + p[0][1]*(-(p[2][2]*p[3][0]) + p[1][2]*(-p[2][0] + p[3][0]) + p[1][0]*(p[2][2] - p[3][2]) + p[2][0]*p[3][2]);
	...
	public:
	  ...
	  static result_t apply(const points_t p) {
	    ...
	    result[1][0]=
	      ((p[0][0] - p[1][0] - p[2][0] - p[3][0])*(-(p[0][0]*p[1][2]*p[2][1]) + p[0][0]*p[1][1]*p[2][2] + p[1][2]*p[2][1]*p[3][0] - p[1][1]*p[2][2]*p[3][0] + p[0][0]*p[1][2]*p[3][1] - p[1][2]*p[2][0]*p[3][1] - p[0][0]*p[2][2]*p[3][1] + p[1][0]*p[2][2]*p[3][1] + p[0][2]*(-(p[2][1]*p[3][0]) + p[1][1]*(-p[2][0] + p[3][0]) + p[1][0]*(p[2][1] - p[3][1]) + p[2][0]*p[3][1]) - p[0][0]*p[1][1]*p[3][2] + p[1][1]*p[2][0]*p[3][2] + p[0][0]*p[2][1]*p[3][2] - p[1][0]*p[2][1]*p[3][2] + p[0][1]*(p[1][2]*(p[2][0] - p[3][0]) + p[2][2]*p[3][0] - p[2][0]*p[3][2] + p[1][0]*(-p[2][2] + p[3][2]))))/2;

	    result[2][0]=
	      ((p[0][1] - p[1][1] - p[2][1] - p[3][1])*(-(p[0][0]*p[1][2]*p[2][1]) + p[0][0]*p[1][1]*p[2][2] + p[1][2]*p[2][1]*p[3][0] - p[1][1]*p[2][2]*p[3][0] + p[0][0]*p[1][2]*p[3][1] - p[1][2]*p[2][0]*p[3][1] - p[0][0]*p[2][2]*p[3][1] + p[1][0]*p[2][2]*p[3][1] + p[0][2]*(-(p[2][1]*p[3][0]) + p[1][1]*(-p[2][0] + p[3][0]) + p[1][0]*(p[2][1] - p[3][1]) + p[2][0]*p[3][1]) - p[0][0]*p[1][1]*p[3][2] + p[1][1]*p[2][0]*p[3][2] + p[0][0]*p[2][1]*p[3][2] - p[1][0]*p[2][1]*p[3][2] + p[0][1]*(p[1][2]*(p[2][0] - p[3][0]) + p[2][2]*p[3][0] - p[2][0]*p[3][2] + p[1][0]*(-p[2][2] + p[3][2]))))/2;

	    result[3][0]=
	      -((p[0][2] - p[1][2] - p[2][2] - p[3][2])*(p[0][0]*p[1][2]*p[2][1] - p[0][0]*p[1][1]*p[2][2] - p[1][2]*p[2][1]*p[3][0] + p[1][1]*p[2][2]*p[3][0] - p[0][0]*p[1][2]*p[3][1] + p[1][2]*p[2][0]*p[3][1] + p[0][0]*p[2][2]*p[3][1] - p[1][0]*p[2][2]*p[3][1] + p[0][2]*(p[1][1]*(p[2][0] - p[3][0]) + p[2][1]*p[3][0] - p[2][0]*p[3][1] + p[1][0]*(-p[2][1] + p[3][1])) + p[0][0]*p[1][1]*p[3][2] - p[1][1]*p[2][0]*p[3][2] - p[0][0]*p[2][1]*p[3][2] + p[1][0]*p[2][1]*p[3][2] + p[0][1]*(-(p[2][2]*p[3][0]) + p[1][2]*(-p[2][0] + p[3][0]) + p[1][0]*(p[2][2] - p[3][2]) + p[2][0]*p[3][2])))/2;
