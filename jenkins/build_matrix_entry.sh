...
if [[ $build_type == "thrust" ]]; then
  ...
  tangram_install_dir_nompi=$NGC/private/tangram/${tangram_version}-thrust-${compiler_type}-${gcc_version}-nompi
else
  tangram_install_dir=$NGC/private/tangram/${tangram_version}-boost-${compiler_type}-${compiler_version}-openmpi-${openmpi_version}
  tangram_install_dir_nompi=$NGC/private/tangram/${tangram_version}-boost-${compiler_type}-${gcc_version}-nompi
fi
